...
Using a dataset corresponding to 35.86\fbinv, a production cross section of $409.8^{126.0}_{-163.0}$ pb was measured for this process when the Z boson decays into a pair of leptons.
This corresponds to an observed (expected) signal significance of $999 \sigma$ ($999^{+999}_{-999} \sigma$ ) compared to the background-only hypothesis, which is consistent with the Standard Model prediction and the measurements made using the final state where the Z boson and W boson decay leptonically.
