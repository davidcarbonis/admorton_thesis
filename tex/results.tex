...
For the combination of both final states, at 95\% CL, the observed signal strength for tZq production was determined to be $5.366_{-1.638}^{+1.565}$

, corresponding to an expected significance of $3.547 \sigma$. %$4.74^{+1.69}_{-1.51$}
...
In Figure~\ref{fig:systematicsPull} it can be seen that the during the fit that the cross section and NPL normalisation  
