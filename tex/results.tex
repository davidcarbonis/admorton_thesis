...
The impact of the ME - PS matching energy threshold nuisances parameters on the $\hat{\mu}$ is comparable to that of the most significant experimental sources of uncertainty, after those associated with the PDFs.
...
The precision of the measurement would also significantly benefit from a reduction in the uncertainties associated with the jet energy corrections given that the impact of varying the JES nuisance parameter for the $ee$ channel is comparable to the ME scale's and the impact of varying the JER nuisance parameter for the $\mu\mu$ channel is similar to the ISR's and FSR's. %%% Maybe exclude/rewrite?
