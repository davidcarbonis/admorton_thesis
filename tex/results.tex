...
The CMS Collaboration has performed shapes analyses using BDTs at both $\sqrt{s} = 8 \TeV$ and $\sqrt{s} = 13 \TeV$.
...
The subsequent search by the CMS Collabration at $\sqrt{s} = 13 \TeV$ observed tZq production, measuring a signal strength of $1.22^{0.98}_{-0.85}$ with an observed (expected) significance of $3.7 \sigma$ ($3.1\sigma$) using the 2016 dataset of 35.9\fbinv~\cite{Sirunyan:2017nbr}.
The ATLAS collaboration has also observed tZq using the trilepton final state at $\sqrt{s} = 13 \TeV$~\cite{Aaboud:2017ylb}, measuring a signal strength of $0.75 \pm 0.28$ at an observed (expected) significance of $4.2\sigma$ ($5.4\sigma$) using 36.1\fbinv of data collected during 2015-2016.

%%% How do trilepton and dilepton differ?
The observed significance of the measurement presented in this thesis is consistent within two standard deviations of both the SM prediction and the previous measurements of tZq that have been made using the trilepton final state.

he expected significance of the measurement made using the dilepton final state however, is significantly less than the previous measurements. 

While the measurements of tZq that have been made using the trilepton final state share some 
All of the observed significances of the tZq measurements made using the trilepton final state are greater than the expected significance of the measurement made using the dilepton final state.
