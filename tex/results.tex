...
Despite the large conservative rate uncertainty ascribed to the non-prompt lepton fake shapes, given their relatively small contribution compared to other background processes and the effectiveness of the BDT in separating si, the impact 
...
Following the first search made for the tZq trilepton final state at $\sqrt{s} = 8 \TeV$ by the CMS collaboration reporting a significance of 2.9 standard deviations~\cite{Sirunyan:2017kkr}, both the ATLAS and CMS collaborations have performed searches at $\sqrt{s} = 13 \TeV$.
Both the ATLAS and CMS searches at at $\sqrt{s} = 13 \TeV$ have observed this process with reported signifiances of 4.2 and 3.7 standard deviations respectively~\cite{Aaboud:2017ylb,Sirunyan:2017nbr}.


While all of the 
While both of the $\sqrt{s} = 13 \TeV$ trilepton final state analyses and the dilepton final state analysis presented all use a binned maximum likelihood fit of a multivariate discriminant, the analysis strategies they all employ differ.
