...
\begin{figure}[!h]
\centering
\includegraphics[width=0.9\textwidth]{figs/results/postfit_ee.pdf}
\\
\includegraphics[width=0.9\textwidth]{figs/results/postfit_mumu.pdf}
\caption{
...
In addition, it was found that the impact of the ME - PS matching energy threshold nuisances parameters were comparable to that of the most significant experimental uncertainties, after those associated with the PDFs.
Consequently, the measurement's precision would be best improved by an improved theoretical understanding of tZq production and the dominant background processes and by a reduction in the uncertainty on the parton distributions used for generating MC samples. 

%In addition it was found that the impact of varying the JES nuisance parameter for the $ee$ channel was comparable to the ME scale's and the impact of the JER nuisance parameter for the $\mu\mu$ channel is similar to the ISR's and FSR's.
%As such, the precision of the measurement would also significantly benefit from a reduction in the uncertainties associated with the jet energy corrections.  
...
In contrast, despite being constrained in the fit, both the \ttbar and Z+jets normalisation uncertainties had a significant impact on the $\hat{\mu}$, with the \ttbar cross section uncertainty having an impact on the $\hat{\mu}$ comparable to the theoretical scale for the $\mu\mu$ final state.
In addition, it was found that both the \ttbar and Z+jets cross section normalisation nuisance parameters were offset from their pre-fit values.
Given that the cause for these offsets was not understood at the time of the unblinding of this analysis, it is imperative for future measurements that their cause is established in order to ensure that the two most important background processes for this search are properly understood.
