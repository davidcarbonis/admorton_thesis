...
Previously the production of a single top quark in association with a Z boson has been searched for using the trilepton final state at the LHC.% at $\sqrt{s} = 8 \TeV$ and $\sqrt{s} = 13 \TeV$.
The first search for tZq production was made at $\sqrt{s} = 8 \TeV$ using 19.7\fbinv of data that was collected during 2012 by the CMS Collaboration~\cite{Sirunyan:2017kkr}, measuring a signal strength of $1.22^{0.98}_{-0.85}$ at an observed significance of $2.9 \sigma$.
The ATLAS and CMS collaborations have both subsequently observed tZq using the trilepton final state at $\sqrt{s} = 13 \TeV$.

 measuring signal strengths of $0.75 \pm 0.28$ and $1.22^{0.98}_{-0.85}$ 
that corresponded to observed significances of $4.2\sigma$ and $3.7\sigma$, respectively~\cite{Aaboud:2017ylb,Sirunyan:2017nbr}.

CMS - 2016 35.9 \fbinv 
ATLAS - 2015-2016 36.1\fbinv
