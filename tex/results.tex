...
Using the reference NLO cross section of $\sigma (tZq, Z \rightarrow l^{+} l^{-}$) = 94.2~fb~\cite{Campbell:2013yla}, these signal strengths corresponds to cross section of $505.5^{147.4}_{-154.3}$~fb and $505.5^{147.4}_{-154.3}$~fb, respectively. %$94.2^{+95.3}_{-98.4475}$.
...
\begin{table}[h]
   ...
   \begin{tabular}{ccc}
       ...
       Cross section (fb) & $292.6_{-126.9}^{+100.2}$ & $222.5_{-94.9}^{+90.2}$ & - \\
...
BDT discriminant distributions following the MLF for data and simulation are shown in Figure~\ref{fig:postfitBDT}.
When compared to the pre-fit distributions in Figure~\ref{fig:postfitBDT}, it can be seen that the 
...
\caption{The central values and uncertainties of the nuisance parameters (left-hand side) and the impact of each systematic uncertainty (when varied by $\pm 1 \sigma$) on the signal strength parameter $\mu$ following the fit
}
