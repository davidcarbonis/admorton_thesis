...
When compared to the pre-fit distributions in Figure~\ref{fig:postfitBDT}, it can be seen that the MLF not only constrains the impact of the systematic uncertainties, but also enhances 
...
Figure~\ref{fig:systematicsPull} illustrates the impact of each of the sources of systematic uncertainty on the signal strength modifier $\mu$.
The pulls of the nuisance parameters, defined as the difference between the pre-fit and post-fit values of a nuisance parameter divided by its pre-fit uncertainty, are shown on the left-hand side of Figure~\ref{fig:systematicsPull}.
The impact of varying a nuisance parameter to its $\pm \sigma$ post-fit values on the $\mu$ is shown on the right hand side of Figure~\ref{fig:systematicsPull}.


It can be seen that the post-fit uncertainty on the X systematics has decreased with respect to their initial values
If the error bars of the pull of a nuisance parameter is smaller than one, the parameter has been constrained in the MLF.


In Figure~\ref{fig:systematicsPull} it can be seen that the fit ... that the cross section and NPL normalisation  
...
\caption{The central values and uncertainties of the nuisance parameters (left hand side) and the impact of each systematic uncertainty (when varied by $\pm 1 \sigma$) on the signal strength parameter $\mu$ for the $ee$ channel (top) and $\mu\mu$ channel (bottom) following the fit.}
