...
For the combination of both final states, at 95\% CL, the observed signal strength for tZq production was determined to be $4.35^{+1.72}_{1.73}$, corresponding to an expected significance of $3.20 \sigma$. %$4.74^{+1.69}_{-1.51$}

Using the reference NLO cross section of $\sigma (tZq, Z \rightarrow l^{+} l^{-}$) = 94.2 fb~\cite{Campbell:2013yla}, this results corresponds to a ... the cross section of $409.8^{126.0}_{-163.0}$ fb. %$94.2^{+95.3}_{-98.4475}$.
...
The significance of measuring tZq using the dilepton final state however, is expected to be significantly smaller at $0.95 \sigma$.
...
While contributions from NPL and WZ processes that form the largest backgrounds for the searches using the trilepton final state, given the 
