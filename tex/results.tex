...
Therefore, the precision of the measurement would be improved by an improved theoretical understanding of tZq production and the dominant background processes and by a reduction in the uncertainty on the parton distributions used for generating MC samples. 
