...
Normalisation uncertainties take the form of log-normal nuisance parameters, which avoid 
...
\editComment{Add bit on how the Z+jets normalisation uncert was incorporated}
...
The test statistic used at the LHC by the ATLAS and CMS collaborations is the log likelihood ratio defined in equation~\ref{eq:testStatistic}, where 
