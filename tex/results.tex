...
As producing pseudo-data using an ensemble of toy simulation samples to obtain the values for s+b and b hypotheses' likelihood functions can be computationally intensive, the \emph{asymptotic} method is used when the number of expected events is sufficiently large.
...
This method was used for the analysis presented to remove the need to 
...
%While all of the experimental uncertainties have been constrained in the fit,
