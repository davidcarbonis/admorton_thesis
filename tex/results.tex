...
%The result would also improved by an improved understanding of the evolution of 
% impact of the matrix element - parton shower matching energy threshold uncertainties on the $\hat{\mu}$ is comparable to the 

%
% The JES uncertainityfor the $ee$ final state were the second most impactful experimental uncertainity and the JER uncertainty 
%Given the significant multi-jet component of the signal process' final state, it is not unexpected that jet related uncertainties were amongst the most 
...
%As the best fit values of the nuisance parameters for the cross section normalisation are not at or near the limits of their error bars, 
