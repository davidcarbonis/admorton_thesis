...
The first observation of tZq using the trilepton final state was made by the ATLAS and CMS collaborations at $\sqrt{s} = 13 \TeV$, with observed(expected) significances of 4.2(5.4) and 3.7(3.1) standard deviations, respectively~\cite{Aaboud:2017ylb,Sirunyan:2017nbr}.
