...
The \combine tool is based on the RooStats package~\cite{Moneta:2010pm,Schott:2012zb}
...
The comparison of the trigger efficiencies in simulation for \ttbar and Z+jets, the impacts of the \MET trigger selection and the further event selection


 systematic studies were performed to estimate the systematic uncertainty associated with the lepton trigger scale factors. 
