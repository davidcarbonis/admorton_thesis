...
The \combine tool is based on the RooStats package~\cite{Moneta:2010pm,Schott:2012zb} and determines the signal strength using a Maximum Binned Likelihood Fit (MLF) and the significances using using an asymptotic approximation~\cite{AsymptoticFormulae}, using the Asimov dataset.
