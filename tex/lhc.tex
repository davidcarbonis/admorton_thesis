...
Pseudorapidity, defined as $\eta \equiv -ln\tan(\theta/2)$, is usually used in lieu of $\theta$ as $\eta$ is Lorentz invariant along the z-axis 


%and converges towards rapidity, defined as $y \equiv \frac{1}{2} ln(E+p_{z}/E-p_{Z})$, for highly relativistic particles 
