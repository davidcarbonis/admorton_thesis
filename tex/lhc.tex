...
Given that the the time limitations on the HLT are not as strict as the L1 Trigger, with events requiring an average of $\approx 40ms$, more sophisticated reconstruction and selection algorithms are used.
