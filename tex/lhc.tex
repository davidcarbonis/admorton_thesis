...
The LHC Achieving such a high instantaneous luminosity was achieved by 

Protons are delivered in 2808 bunches per beam, as opposed to a continuous beam, which at design luminosity will separated by 25ns, resulting in an bunch collision rate of up to 40\MHz.

To further increase the instantaneous luminosity, the protons bunches are squeezed in order to enhance the number of simultaneous inelastic proton-proton interactions during each bunch crossing.

 and an average of 25 inelastic proton-proton interactions, named pile-up (\PU) for each bunch crossing~\cite{Bruning:782076,Ball:2007zza}. 
...
There is also a pair of very-forward calorimeters (HF) in the forward rapidity region.
