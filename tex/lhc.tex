...
\item the use of spare processors to test new algorithms online in parallel with the nominal trigger and as backup processors in case of the failure of another.
\end{itemize} 
