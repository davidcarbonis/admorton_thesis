...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.97\textwidth]{figs/cms/a194Ts.jpg}
\caption{The pixel detector endcap disks being reinstalled around the beam pipe in December 2014 following Long Shutdown 1~\cite{Hoch:1977415}.}
\label{fig:pixel}
\end{center}
\end{figure}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.97\textwidth]{figs/cms/0610026_01.png}
\caption{The first half of the Tracker Inner Barrel (TIB) containing three layers of silicon strip modules~\cite{Maximilien:995912}.}
\label{fig:TIB}
\end{center}
\end{figure}
