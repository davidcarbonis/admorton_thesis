\chapter{The LHC accelerator and the CMS experiment}\label{sec:lhc-cms}
\section{The Large Hadron Collider}\label{subsec:lhc}
...
\section{The Compact Muon Solenoid}\label{subsec:cms}
\subsection{Overview}
...
\subsection{Tracker}\label{subsubsec:tracker}
...
\subsection{Electromagnetic Calorimeter}\label{subsubsec:ECAL}
...
\subsection{Hadronic Calorimeter}\label{subsubsec:HCAL}
...
\subsection{The Superconducting Solenoid}\label{subsubsec:magnet}
...
\subsection{Muon Detectors}\label{subsubsec:muon chambers}
...
\subsection{Trigger and Data Acquisition Systems}\label{subsubsec:trigger}
