...
An iron return yoke guides and contains the return magnetic field, which is strong ($\approx$ 1.7~T in the barrel and outermost endcap disk) enough to enable accurate momentum resolution for tracking and charge identification of high momentum ($\approx$ 1\TeVc) muons.
