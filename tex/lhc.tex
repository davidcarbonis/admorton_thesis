...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.97\textwidth]{figs/cms/DTchamber.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.97\textwidth]{figs/cms/csc_trapezoid_v1.pdf}
...
During 2016, the LHC operated at $\sqrt{13} \TeV$ up to a maximum instantaneous luminosity of $15.3 \times 10^{33}$ \percms ~\cite{cmsLumiPage}
