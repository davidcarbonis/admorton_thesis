...
As a consequence
In the 
The tracker system is capable of reconstructing tracks for charged particles with $\pT > 1 \GeV$ at an efficiency greater than 99\%,

in prescence of strong b field ... 
 an impact parameter resolution of approximately $10\mum$ for charged particles with $\pT = 100\GeV$ and momentum resolutions between $1.5\%$ and $3.0\%$ for charged particles with $1 < \pT < 100\GeV$~\cite{Khachatryan:2010pw,Chatrchyan:2014fea}.
...
%
Tracking information is not used in the L-1 Trigger decision as it was not possible to read out every event  and consequently, it has not been designed to be read out for every event.
%
