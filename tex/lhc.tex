...
Collectively, these systems provide 
Improved performance however, can be achieved through making use of tracking information (as described in Chapter~\ref{chapter:data-mc}}).
This additional information allow for 
