...
As a significant proportion of the tracks reconstructed by the linearised $\chi^{2}$ fit contain either at least one incorrect stub the values for the two tracking efficiency definitions are not equal.
...
As such ``fake'' stubs are expected have large residuals compared to stubs correctly associated to genuine tracks or if
...
Such and given that the residuals of each stub were known following a fit.
