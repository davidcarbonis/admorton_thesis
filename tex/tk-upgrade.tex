...
As effects of \MS only dominate at low $\pT$, there was no

Only negligible differences in the resolutions of the helix parameters at higher \pT (low $\frac{1}{\pT}$) due to the negligible effect of \MS at higher energies.
...
Both of the $\phi_{0}$ and $z_{0}$ resolutions were observed ... cause

%% constant /MS coefficient gives best perofmance
The inconsistent 
...
The improved performance gained by considering \MS is further illustrated by the distribution of $\frac{\chi^{2}}{ndf}$ as a function of $\frac{1}{\pT}$ in Figure~\ref{fig:2GeVTiltChi2Ndf}.
