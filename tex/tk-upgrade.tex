...
Following the December 2016 demonstrator review and the proposition of the \emph{tilted} barrel geometry, \editComment{what impact did the new geometry have?}, the modification of the uncertainties associated with a \KF state to take into account the impact of multiple scattering for low \pT tracks was explored.

The starting point was the adding an additive constant of the order of a milliradian, the estimated amount of scattering, to inflate the r-$\varphi$ error in the \KF.
