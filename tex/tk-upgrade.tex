...
This is illustrated by the looking at the $\chi^{2} \div \text{number of degrees of freedom}$ ($\frac{\chi^{2}}{ndf}$) as a function of $\frac{1}{\pT}$ in Fig.~\ref{fig:2GeVFlatChi2Ndf}, where $\frac{\chi^{2}}{ndf}$ is approximately flat near unity for high \pT (low $\frac{1}{\pT}$) but significantly increases 
...
Due to the time constraints in undertaking these studies in time for the December 2016 demonstrator review, studies accounting for the effects of MS within the \KF were undertaken followine review.
Following the review all studies made use of the proposed emph{tilted} barrel geometry. 
%%%
