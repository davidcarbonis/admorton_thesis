...
In contrast though, the duplicate increases for both coefficients by 3-5\% for the full chain, with the increase in duplicates occurring around the \pT at which reduced precision of \HT cells are used.
At the time of writing this chapter, it is not understood how incorporating \MS into the \KF causes this. \editComment{It is hoped that by the time of submission, someone will have figured this out.}
...
Both \MS coefficients 
... the effects of \MS which dominate at low transverse momenta are significantly 
