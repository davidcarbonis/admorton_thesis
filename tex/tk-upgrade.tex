...
The software implementation of Eqn.~\ref{eq:chi4} 
...
\includegraphics[width=0.47\textwidth]{figs/tk-upgrade/results-lowPtTracking/kfFracDuplicatesVsInvPtTiltedGeometry_5000-logo.pdf}
...
\item separate \KF $\chi^{2}$ cuts for the \rphi and r-z planes ... WHY?
