...
As such, all the following results discussed were produced using the \textit{tilted} barrel geometry.
...
\begin{itemize}
\item determining suitable coefficients as functions of both \pT and $\eta$ experimentally through simulation in order to produce ... account for the amount of material traversed.
to account for the increased hit resolution error of a stub based on the  previously traversed.
