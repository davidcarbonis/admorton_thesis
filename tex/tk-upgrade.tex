...
The High-Luminosity Large Hadron Collider (HL-HLC) upgrade is expected to be installed during Long Shutdown 3 which is expected to occur during 2023-2025~\cite{ApollinariG.:2017ojx}.
Following its installation, the HL-LHC will be capable of delivering an instantaneous luminosity of the LHC increasing up to $5-7.5 \times {10}^{34}$\percms, which corresponds to an average number of proton-proton interactions per 40\MHz bunch crossing of 140 to 200.
This will allow both the ATLAS and CMS experiments to record a total integrated luminosity of up to of 3000\fbinv during the 10 year planned lifetime of the HL-LHC.
