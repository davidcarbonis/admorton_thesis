...
While the \HT is highly efficient method of finding track candidates, over half the track candidates are considered to be \emph{fake} or contain at least one incorrectly associated stub.
Therefore, a Kalman Filter was used to filter the tracks candidates whilst precisely fitting their track parameters.
