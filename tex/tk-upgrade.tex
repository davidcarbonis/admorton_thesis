...
Table~\ref{tab:trackFindingPerformance2GeVHT} shows how 
...
%%% Say something about the two similar approaches

the coefficient as a function of the layer ID, does not 
