...
Following the validation of a floating point version of the algorithm, a version was developed using approximated expressions of the track derivatives in order to simply (and reduce resources required for) any future derivative tabulation by reducing the number of variables that it would depend on.
