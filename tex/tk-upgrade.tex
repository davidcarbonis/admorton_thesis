...
Given that stubs which are either incorrectly associated with a track or belong to a fake would be expected have larger residuals than those which are correctly associated, once a fit has been performed and the residuals of each stub are known, filtering of the stubs can be undertaken
