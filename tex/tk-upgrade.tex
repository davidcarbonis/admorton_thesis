...
Both floating point and discretised mathematics implementations give comparable results, indicating that the approximations made are acceptable.
...
A linearised $\chi^{2}$ track fitting algorithm was developed ... us
and shown to be 

A linearised $\chi^{2}$ track fitting algorithm was the first track fitting algorithm developed and was shown to be capable of fitting precise helix parameters to the track candidates found by the \HT and identifying and removing both hits that were incorrectly matched to genuine track candidates and unmatched track candidates.
