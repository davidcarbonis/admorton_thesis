...
The optiminal value of $T$ was determined to be 58 cm.
...
While the \HT is highly efficient at finding tracks, it produces candidates with coarse rphi helix parameters and over half the track candidates are considered to be \emph{fake} or contain at least one incorrectly associated stub.
