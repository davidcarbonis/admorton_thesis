...
\subsubsection{General Form of a $\chi^{2}$ Fit}
...
The calculation of the derivatives that form the matrix elements of M and D are given in~\ref{app:chi2}.
...
\subsubsection{Firmware Feasibility}
%% Matrix sizes
...
\begin{itemize}
\item Improving the purity of the fitted tracks. \editComment{Remark on LR +KF having 100\% purity}.
...
\item 
\end{itemize}
%A linearised $\chi^{2}$ fitter was also explored by the \emph{tracklet} proposal
