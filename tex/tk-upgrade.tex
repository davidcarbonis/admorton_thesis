...
Following the validation of the floating point implementation of the linear $\chi^{2}$ track fitter in software, 
...
As the first order approximation of the derivatives for the barrel hits only depend on the radial position of the hit (\ie one of the six possible barrel layer radial positions), only a small number of LUTs (\editComment{6?}) are required for these matrix elements.
