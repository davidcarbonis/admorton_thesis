...
f_{i}(\overrightarrow{h} ) = f_{i}(\overrightarrow{h} + \delta \overrightarrow{h}) \;
                           = f_{i}(\overline{h} + \delta \overline{h} \frac{\partial f_{i}}{\partial \overline{h}} + \mathcal{O}(\delta \overline{h}^{2}) \;
\label{eq:chi1}
\end{equation}
...
As the linear forms of equations~\ref{eq:chi4} and~\ref{eq:chi5f} consist of repeated addition and multiplication operations of the matrices involved, they are naturally suitable for implementation on an FPGA.
...
From equations~\ref{eq:chi4} and~\ref{eq:chi5f} and the track derivatives derived in Appendix~\ref{app:chi2}, a software implementation of the linearised $\chi^{2}$ track fit algorithm was developed.
