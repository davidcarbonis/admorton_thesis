...
In addition, simulation studies indicated that approximately half of the track candidates created by the Hough Transform did not have stubs associated to the same particle in at least four tracker layers (\ie were fake).
