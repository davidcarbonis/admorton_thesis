...
%        \hline
%    Default & \bf{HT}     &  93.6 &  719  &  247 &   318 \\  
%    & \bf{Full chain}     &  89.2 &  196   &  42  &     10 \\      
%   \hline
%        \hline
%    Merge & \bf{HT}     &  94.5 &  808  &  330 &   319 \\  
%    & \bf{Full chain}     &  89.8 &  209   &  53  &     8 \\      
%   \hline
%        \hline
%    Optimised & \bf{HT}     &  94.5 &  808  &  330 &   319 \\  
%    & \bf{Full chain}     &  90.0 &  213   &  56  &     8 \\      
%   \hline
%   
% \end{tabular}
% \addtolength{\tabcolsep}{-1ex}
...
%=========================================================================
%               TRACK-FINDING SUMMARY (before track fit)
%Number of track candidates found per event = 808.2100 +- 18.1206
%                     with mean stubs/track = 7.4645
%Fraction of track cands that are fake = 0.4080
%Fraction of track cands that are genuine, but extra duplicates = 0.3948
%Algorithmic tracking efficiency = 2304/2439 = 0.9446 +- 0.0046
%Perfect algorithmic tracking efficiency = 981/2439 = 0.4022 +- 0.0099 (no incorrect hits)
%=========================================================================
%                    GENERAL FITTING SUMMARY FOR: KF4ParamsComb
%Number of fitted track candidates found per event = 208.7700 +- 2.8352
%                            with mean stubs/track = 4.0000
%Fraction of fitted tracks that are fake = 0.2551
%Fraction of fitted tracks that are genuine, but extra duplicates (post-cut) = 0.0394
%Algorithmic fitting efficiency (post-cut) = 2190/2439 = 0.8979 +- 0.0061
%Perfect algorithmic fitting efficiency(post-cut) = 2190/2439 = 0.8979 +- 0.0061 (no incorrect hits)
%=========================================================================
%% optimised KF
%=========================================================================
%               TRACK-FINDING SUMMARY (before track fit)
...
%=========================================================================
%                    GENERAL FITTING SUMMARY FOR: KF4ParamsComb
%Number of fitted track candidates found per event = 212.9900 +- 2.8835
%                            with mean stubs/track = 4.0000
%Fraction of fitted tracks that are fake = 0.2633
%Fraction of fitted tracks that are genuine, but extra duplicates (post-cut) = 0.0390
%Algorithmic fitting efficiency (post-cut) = 2195/2439 = 0.9000 +- 0.0061
%Perfect algorithmic fitting efficiency(post-cut) = 2195/2439 = 0.9000 +- 0.0061 (no incorrect hits)
%=========================================================================
...
\editComment{Comment on resolutions, etc}
%%% Results
...
%\begin{table}[htbp]
%\topcaption {Track finding performance on simulated \ttbar events at a \PU of 200, after the \HT and the full chain (\HT + \KF + \DR) for the optiminal \HT configuration discussed above and the three differing \KF configurations where \MS is not considered (\emph{no \MS}), a constant \MS coefficient (\emph{$k$}) is used and a layer depedent \MS coefficient (\emph{$k(layer)$})is used. The track finding efficiencies, the mean numbers of reconstructed tracks per event in the entire tracker, and the number of those tracks which are fakes or duplicates, are given using the efficiency definitions described in Chapter~\ref{TmttSimStudies}.}
