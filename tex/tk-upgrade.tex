...
Th basis for the \emph{TMTT}'s implementation of the algorithm is detailed in~\cite{CMS_DN-14-043}. \editComment{Need to check re. there being a publicly available copy?}
