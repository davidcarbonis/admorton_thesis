...
For the simplest case of detecting straight lines, the Hough Transform describes a set of points $(x,y)$ in real space in terms of 
As such, given that points in real space are represented as a line in Hough Space, the intercept of these lines
...
Further discussion of the mathematics and implementation of online track reconstruction using Kalman Filters on FPGAs can be found in~\cite{SSummers}.
...
The development of a Kalman Filter track fitter was motivated by its property of being the optimal method of filtering a linear system and determining an estimate of the system's parameters.
