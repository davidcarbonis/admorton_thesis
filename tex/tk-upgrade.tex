...
The Hough Transform algorithm is a widely used method of detecting geometric features in digital image processing~\cite{HT} and is used by the TFP to reconstruct primary charged particles tracks from a set of stubs.
