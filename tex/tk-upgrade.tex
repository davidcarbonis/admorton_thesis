...
A significant proportion of the tracks reconstructed by the linearised $\chi^{2}$ fit, as shown in table~\ref{tab:chi2-exactVsApprox}, contain either at least one incorrect stub, resulting in the values for the two tracking efficiency definitions being not equal.
...
During the optimisation of this cut, it was found that a track could end up with having fewer than the minimum of four stubs required to be considered track candidate - thus potentially discarding a matched track by mistake!
