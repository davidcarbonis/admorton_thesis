...
The Hough Transform algorithm is a widely used method of detecting geometric features, such as straight lines, in digital image processing~\cite{HT}.
The simplest version of the Hough Transform 

%%% GENERAL INTRO

The \HT is used by the TFP to find charged particles tracks with $\pT > 3\GeV$ in the \rphi plane using data from the upgraded tracker. 



The radius of a charged particle passing through a aracking volume, permeated by a homogeneous 3.8T magnetic field ($B$), can be described as a function of its \pT and charge $q$:
