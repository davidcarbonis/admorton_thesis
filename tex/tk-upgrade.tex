...
From Eqns~\ref{eq:chi4,eq:chi5} and the track derivatives $D_{ij}$ derived in Appendix~\ref{app:chi2}, a floating point software implementation of the algorithm was initially developed to both validate the algorithm and to optimise its performance prior to producing a version ...
