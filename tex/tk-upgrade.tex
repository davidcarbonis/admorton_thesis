...
The installation of the HL-HLC upgrade is planned to take occur during Long Shutdown 3 (LS3), which is currently expected to start during 2024~\cite{ApollinariG.:2017ojx}. 
...
%
A full description of the Kalman formalism is given in~\cite{Fruhwirth:1987fm} and the details of the \emph{TMTT} project's implementation of the Kalman Filter using FPGAs for online track reconstruction is given in~\cite{TMTT_JINST,SSummers}.
