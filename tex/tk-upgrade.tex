...
\begin{figure}[tbp]
\centering
\includegraphics[width=\textwidth]{figs/tk-upgrade/results-lowPtTracking/htTrackingEffVsInvPtFlatGeometry_1000.pdf}
\caption{\editComment{Chi2/ndf vs invPt plot to be added once the backported plot code (from titled geometry histo code) to the flat geometry histo code has run to create these plots.}}
