...
%%%The form of the multiple scattering contribution, $\sigma_{\theta}$, must be considered in a form that requires minimal resources and time to use.
...
\begin{equation}
\sigma_{\theta} = \frac{const}{r_{track}}
\label{eq:scatter2}
\end{equation}

From the simplified form of Eq.~\ref{eq:scatter2}, two alternative approaches for modelling the effects of \MS were 
