...
A time-multiplexed design has a number of advantages, as discussed in~\ref{paragraph:L1}, including that only a single processor is required to demonstrate the full system as each processor is identical in every respect except for LHC bunch crossing they process.

By treating the DTC system as the first layer, and the 
...
The Xilinx Virtex-7 FPGAs on MP7 boards developed for the Phase-I Calorimeter Trigger Upgrade, 
...
A hardware demonstrator, capable of processing one phi-octant of the tracker with a time-multiplexing factor of 36 and composed of Xilinx Virtex-7 FPGAs on MP7 boards (developed for the Phase-I Calorimeter Trigger Upgrade), was used to validate the feasibility of the proposed system and all its components for the December 2016 review.
All of its results achieved, and a more complete description of the system, are given in~\cite{TMTT_JINST}.
