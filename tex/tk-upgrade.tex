...
In contrast, the accuracy of resolutions of the other three helix parameters are not degraded 
...
A linearised $\chi^{2}$ track fitting algorithm was developed and shown to be capable of efficiently finding tracks
