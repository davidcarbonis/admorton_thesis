...
Diboson processes involving the presence of a leptonically decaying Z decay and either a W or Z boson hadronically decaying with additional jets from gluon splitting are anticipated to be the predominant source of background from these processes.
...
In light of the small production cross sections of the tribosonic backgrounds, even when their leading order final states are consistent with the tZq event selection criteria, these processes are anticipated to be some of the few minor background sources.
