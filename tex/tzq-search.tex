...
The presence of only two leptons from the Z boson decay presents the the main challenge for this analysis, as it results in an event topology identical to a large number of background processes which have cross sections many order of magnitude larger than the signal process.
As these background processes , search was designed to use ...
