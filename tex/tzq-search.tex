...
As such, given the background dominated nature of this search, it would have been challenging to separate this small signal contribution from the background processes.  
