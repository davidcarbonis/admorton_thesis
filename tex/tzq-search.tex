...
As the tZq dilepton final state is distinguished by the Z boson decaying leptonically and the W boson decaying purely hadronically, it is of upmost importance to be able to identify isolated leptons with a low misidentification rate.
