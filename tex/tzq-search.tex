...
This limit was chosen as it was found that for b-jet multiplicities greater than two there was minimal signal ($< 1\%$) present, which would have been difficult to separate from the large background contributions present.  
