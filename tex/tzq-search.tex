...
Whilst the Z boson can decay into a tau anti-tau pair, with these leptons being simulated and reconstructed in the MC, they are not considered in the event selection for this analysis due to the .. %%% hard to simulate due to their high mass
...
% This right-aligns numbers in column, but centers them under column title.
  \begin{tabular}{ccr@{\hspace{4ex}}r@{\hspace{4ex}}r@{\hspace{4ex}}}
   ...
   \hline
    ee & SingleElectron &  HLT\_Ele32\_eta2p1\_WPTight\_Gsf   \\
    & DoubleElectron & HLT\_Ele23\_Ele12\_CaloIdL\_TrackIdL\_IsoVL\_DZ \\
   \hline
    $\mu\mu$ & SingleMuon &  HLT\_Iso(Tk)Mu24  \\  
        & DoubleMuon  & HLT\_Mu17\_TrkIsoVVL\_(Tk)Mu8\_TrkIsoVVL\_DZ \\  
...
The selection criteria for the \ttbar control region differs from the signal region definition defined in Chapter~\ref{sec:eventSelection}, by requiring that the two leptons selected to have different flavours.
In other words, 
...
\section{Simluation Corrections and Systematic Uncertainties}\label{sec:simCorrections}
