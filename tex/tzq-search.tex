...
\item \textbf{} the relative isolation of the electron, which is described further in Chapter~\ref{subsubsec:relIso}.
\item \textbf{1/E - 1/p} - the difference in the inverse energy of the ECAL supercluster and inverse track momentum, which is used to describe the ...
