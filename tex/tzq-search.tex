...
The signal enriched region event selection was designed select signal events with a high efficiency whilst rejecting as much background from non-prompt leptons and the decay ... as possible.
