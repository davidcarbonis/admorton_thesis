...
Thus four to six jets are required to be present, each of which must satisfy $\pT > 30\GeVc$ and $|\eta| < 4.7$ and as passing the loose jet identification criteria to ensure a high selection efficiency while rejecting the majority of fake jets.
