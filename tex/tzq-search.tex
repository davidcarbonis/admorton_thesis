...
To account for these discrepancies, corrective scale factors are applied to t

The uncertainties associated with these corrections to simulation are described in Chapter~\ref{chapter:systematics}.
...
The Jet Energy Corrections applied to simulation are detailed in Chapter~\ref{subsubsec:JECs}.
\subsection{b-tag modelling}
\subsection{\PU modelling}

\subsection{Top quark p_{T}}
A scale factor is applied to top quarks in \ttbar MC as a function of their generator level transverse momenta to account for the \pt spectra of top quarks in data being significantly softer than that predicted by LO and NLO precision MC simulation~\cite{Khachatryan:2015oqa}.
