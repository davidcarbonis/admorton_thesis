...
This means that final state contains at least four jets, one from the top quark decay, two from the W boson, and the recoil jet and two leptons from the Z boson.
...
Therefore, it is essential that the analysis strategy for selecting tZq events involves both understanding and constrain these 

understand and constrain of backgrounds as much as possible.

Therefore the strategy for selecting tZq events 

The trigger and event cleaning strategies common


Events with large multi-jet components, such as the two largest irreducible processes of Z+jets and \ttbar, form the majority of the background contributions
...
In order to avoid any inadvertent biasing of the measurement made, the analysis presented was \emph{experimentally blinded}.
The motivations behind performing blinded analyses and the methodology used to achieve this for this search.
