...
being able to identify isolated prompt leptons with a high efficiency and a low misidentification rate is essential.



\subsubsection{Electrons}
Any PF electron candidate considered must meet the following kinematic requirements in order to ensure that :

\begin{itemize}
\item the leading electron must have a $\pt > 35\GeVc$
\item the subleading electron 
\item electrons must have $|\eta| \leq 2.50$
\end{itemize}

Identification criteria are applied to these electrons reconstructed in order to identify isolated electrons with a high efficiency and reject those which have been produced from decays from within jets or taus.
...
\subsubsection{Muons}
Similar to the electrons, PF muons must meet a general selection criteria 
