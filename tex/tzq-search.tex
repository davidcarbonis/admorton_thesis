...
For this analysis this is achieved using a $\chi^{2}$-like variable that depends on both the reconstructed top quark mass and the W boson mass for when the distributions of data and MC are compared.
