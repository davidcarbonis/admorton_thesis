...
Following the application of the trigger and event cleaning requirements described in Chapters~\ref{sec:triggerStrategy} and~\ref{sec:metFilters}, a series of requirements 
...
\subsection{Control Regions}\label{sec:controlRegions}
