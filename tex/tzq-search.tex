...
For a number of processes, listed in Table~\ref{tab:theorySampleList}, additional dedicated simulated samples were used to determine the impact of a number of theoretical uncertainties, which are discussed further in Chapter~\ref{sec:theorySysts}.
