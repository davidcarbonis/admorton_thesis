...
Requiring any selected lepton to be sufficiently isolated from jets and heavy leptons s suppressing of these leptons should be achievable by requiring them to be 
...
\ttbar has the next largest production cross section following the V+jets.
...
The electroweak production of multiple vector bosons form the remainder of the background processes to be considered.
