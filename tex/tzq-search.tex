...
Single top production in association with a Z boson 

, and the mass window used for the Z boson mass cut will reject the majority of tHq events where leptonic Higgs boson decays leptonically.


While the \ttbar in association with a vector boson processes have cross sections many orders of magnitude smaller than \ttbar and single top production, 
Minor contributions 

The fully hadronic decay of the top-anti-top pair in \ttbar in associatio 
...
While the dilepton final state of a single top produced in association with both a W and Z boson, tWZ, will be indistinguishable from the tZq final state, as the tWZ cross section is an order of magnitude smaller than tZq's this should be one of the minor backgrounds.
