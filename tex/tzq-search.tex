...
For this analysis this is achieved by two methods: defining a \emph{side-band} region which does  ... and only using pseudo-data
...
The optimised values of $\chi^{2}_{SR}$ and $\chi^{2}_{SB}$ were determined to be X and Y respectively.
