...
The suppressing of these leptons should be achievable by requiring them to be sufficiently isolated from jets and heavy leptons.
...
As the trigger strategy involves the use datasets where lepton triggers have fired, the \pT thresholds have  
...
Given the top quark having a near 100\% probability of decaying into a bottom quark, the event selection requires at least one of the selected jets to be b-tagged.
