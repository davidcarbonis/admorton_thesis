...
The \emph{tight} and \emph{veto} working points of the \emph{cut based} identification criteria defined by CMS are used to select electrons and to veto any additional electrons respectively.
