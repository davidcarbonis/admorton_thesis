...
%Figure~\ref{fig:blindingChi2} illustrates the reconstructed top quark mass and w boson mass distributions for the tZq simulation sample (left) and all simulation samples (right) considered (see Section~\ref{sec:samples}) and the side-band region bounded between the two contour lines.
%
%\begin{figure}[tbp]
%\centering
