...
The blinding methodology used could be improved by using an alternative parametrisation of the $\chi^{2}$-like variable that better describes the structure present in the top quark and W mass distributions and by optimising the values of $\chi^{2}$ used to define the signal and side band regions on the basis of the expected significance of the result in each. 
