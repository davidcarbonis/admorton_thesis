...
It is anticipated that including the 41.5\fbinv of proton-proton collision data at $\sqrt{s} = 13\TeV$ collected by the CMS experiment during 2017 is expected to improve the expected significance of the result to approximately $1.1\sigma$.
...
In addition to incorporating additional data into the analysis, it is expected that the sensitivity of the analysis can be improved upon 
