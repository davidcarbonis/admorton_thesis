...
Given that the observation of tZq is limited by statistics, it is intended to incorporate additional data collected by the CMS experiment in order to improve the sensitivity of the analysis.
Including the 41.5\fbinv of proton-proton collision data at $\sqrt{s} = 13\TeV$ collected by the CMS experiment during 2017 is expected to improve the expected significance of the result to approximately $1.2\sigma$.
...
These datasets have subsequently been reprocessed to incorporate updated jet energy corrections and improved alignments and calibrations of the CMS detector, leading to improved uncertainties on the jet energy scales and resolution.

In addition to including reprocessed and additional datasets, it may be possible to increase the sensitivity of this search through using alternative physics object selection algorithms have been developed.
