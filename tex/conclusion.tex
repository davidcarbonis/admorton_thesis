...
As observation of tZq is limited by statistics, it is intended to extend the analysis to incorporate additional data collected by the CMS experiment.
Including the 41.5\fbinv of proton-proton collision data at $\sqrt{s} = 13\TeV$ collected by the CMS experiment during 2017 is expected to improve the expected significance of the result to approximately $2.2\sigma$.
...
Further sensitivity is anticipated to gained 

In addition to including reprocessed and additional datasets, 


The sensitivity 

Since the analysis was begun, a number of alternative physics selection algorithms have been developed, including a MVA-based lepton selection criteria and b-tagging algorithms that are based on deep neural networks.
While the b-tagging algorithms that use deep neural networks have been shown to have superior performance to the algorithm used in the analysis presented, 


Z+jets and ttbar regions to constrain 

The inclusion of variables computed using the Matrix element method ~\cite{Abazov:2004cs,Sirunyan:2017nbr} - improves expected sig by 20\%
...
Once an accurate measurement of the tZq cross section can be made, it should be possible to probe  the strength of the WWZ coupling to provide 
expected to be as sensitive to this coupling as WZ production
