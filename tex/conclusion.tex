...
A cross section of $\sigma (\textrm{tZq}, Z \rightarrow l^{+} l^{-}) = 505.5^{147.4}_{-154.3}$ fb was measured for the signal process, corresponding to an observed excess over the background-only hypothesis of $2.72\sigma$ and $2.50\sigma$ for the $ee$ and $\mu\mu$ channels, respectively.
...
This is the first measurement of tZq that has been made using the dilepton final state.
...
%Oct 2019 design finalised/August 2020 prototypes validated, Nov 2014 system ready for use
