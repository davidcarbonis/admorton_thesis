...
b-tagging algorithms that use deep neural networks instead of a MLP to produce a discriminator value have been demonstrated to have a higher b-tagging efficiency and lower misidentification rate than the CSVv2 algorithm used in the analysis presented.
