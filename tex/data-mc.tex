...
\caption{The muon reconstruction and \emph{loose} identification efficiency for $13\TeV$ proton-proton collisions in 2016 (circles), MC (squares), and the ratio (bottom inset) between data and MC~\cite{CMS-DP-2017-007}. The loose identification criteria for muons requires that the particle was identified as a muon by the PF algorithm. The statistical uncertainties are smaller than the symbols used to display the measurements.}
