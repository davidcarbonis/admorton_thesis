...
Using these reconstructed particles, additional objects such as  

\subsection{Particle Flow Elements}
The initial stage of reconstructing an event involves the creation of


\subsubsection{Charge Particle Tracks and Primary Vertices}
%%% Tracks
...
Initially this was done with a combinatorial track finder algorithm based on  

The high track reconstruction efficiencies are essential 
...
Through combining the preliminary \emph{elements} above, the Particle Flow algorithm 
