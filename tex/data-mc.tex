...
Parton Distribution Functions are used to provide a detailed description of the internal structure of the two protons in their initial state.

Using this description of the incoming protons, the event generator uses perturbative methods to calculate the Matrix Elements (ME) for the hard interaction .
