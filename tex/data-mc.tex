...
This process involves the \emph{Particle Flow} (PF) algorithm~\cite{CMS-PRF-14-001} combining the physics objects constructed by sub-detectors to reconstruct and identify all the stable particles present in the event, such as electrons, muons, photos and neutral and charged hadrons and from these objects, higher-level objects such as jets, b-jets and missing transverse momentum can be constructed.
...
Correctly determining whether or not a b quark was the progenitor of a jet is incredibly important for a variety of analyses, including top physics searches.

Various \emph{b-tagging} algorithms are supported for use by the CMS B-Tag and Vertexing (BTV) Physics Object Group
