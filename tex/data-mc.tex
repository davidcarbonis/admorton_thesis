...
\caption{The muon reconstruction and \emph{loose} identification efficiency for $13\TeV$ proton-proton collisions in 2015 (circles), MC (squares), and the ratio (bottom inset) between data and MC~\cite{Sirunyan:2018fpa}. The loose identification criteria for muons requires that the particle was identified as a muon by the PF algorithm. The statistical uncertainties are smaller than the symbols used to display the measurements.}
