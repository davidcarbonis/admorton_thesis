...
The initial generation stage models the hard interaction of the two incoming protons, where perturbative methods are used to calculate the Matrix Elements (ME) for the hard interaction.
This stage uses PDFs to provide a detailed description of the internal structure of the two protons in their initial state.
...
The well separated particles produced by the ME stage are \emph{matched} to the lower \pT particles in the PS stage.
