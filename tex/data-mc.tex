...
This process involves the \emph{Particle Flow} (PF) algorithm~\cite{CMS:2009nxa,CMS:2010eua,CMS-PRF-14-001} combining the initial physics objects reconstructed by sub-detectors , 

linking these elements into topological blocks, and the construction higher-level objects such as jets, b-jets and missing transverse momentum.

to reconstruct and identify all the stable particles present in the event, such as electrons, muons, photos and neutral and charged hadrons
...
The PF algorithm reconstructions combines the complementary information from each of the  CMS sub-detectors, as described in Chapter~\ref{chapter:lhc-cms}, to provide an optimal reconstruction and identification of all of the stable particles present in the event. 
