...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.97\textwidth]{figs/data-mc/primaryVertexResolution.png}
...
As shown in Figure~\ref{fig:electronRecoEff}, the resultant electron track collection ...
%% GSF reco 
%% Electron reconstruction efficiency in data (top) and data to MC efficiency ratios (bottom).
%% The efficiency is measured with the tag and probe method and shown as a function of the SuperCluster η
%% \cite{CMS-DP-2017-004}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.97\textwidth]{figs/data-mc/electronGsfRecoEff.pdf}
\caption{The reconstruction efficiency for electrons with $25 \leq \pT \leq 500\GeV$ in $13\TeV$ proton-proton collisions in 2016 and simulation~\cite{CMS-DP-2017-004}. The differences observed between data and MC at high $\eta$ were due to a differing beam spot positions in data and MC}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.97\textwidth]{figs/data-mc/CMS-MUO-16-001_Figure_007.pdf}
