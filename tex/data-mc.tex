...
The initial generation stage models the hard interaction of the two incoming protons, where perturbative methods are used to calculate the Matrix Elements (ME) for the hard interaction and the momentum fractions of the incoming partons are sampled from a PDF.
