...
Monte Carlo (MC) simulations form an essential component of performing any physics analysis.
which provide a detailed, precise and realistic description of the expected SM and potential BSM processes, 
...
\item \textbf{aMC@NLO} - aMC@NLO~\cite{Alwall:2014hca} is a package that can be used to tree-level and one-loop Feynman diagrams to produce matrix elements at NLO.
