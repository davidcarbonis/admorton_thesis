...
Whilst there are several general-purpose event generators which can describe an event from the initial hadron collision to final state particles, they are typically used in conjunction with generators that specialise in a specific physics aspect or process in order to provide a complete event.



The following event generators 
...
Madgraph is package which calculates the matrix element
\subsubsection{POWHEG}
The Positive Weight Hardest Emission Generator (POWHEG)
Alioli:2010xd
\subsubsection{PYTHIA}
PYTHIA is a general-purpose generator which 
