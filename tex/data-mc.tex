...
The electron reconstruction efficiency as a function of the SC $\eta$ for electrons with $25 \leq \pT \leq 500\GeV$ in $13\TeV$ proton-proton collisions in 2016 and simulation is shown in Figure~\ref{fig:electronRecoEff}.
...
%As shown in Figure~\ref{fig:muonRecoEff}, the identification efficiency of PF muons which have Tracker Muon tracks with $\pT > 20\GeV$ exceeded 99\% for $13\TeV$ proton-proton collisions in 2016~\cite{CMS-DP-2017-007}.
%
%\begin{figure}[htbp]
%\centering
%\includegraphics[width=0.7\textwidth]{figs/data-mc/looseMuonIdEff_2016.pdf}
%\caption{The muon \emph{loose} identification efficiency for $13\TeV$ proton-proton collisions in 2016 (circles), MC (squares), and the ratio (bottom inset) between data and MC~\cite{CMS-DP-2017-007}. The loose identification criteria for muons requires that the particle was identified as a muon by the PF algorithm. The statistical uncertainties are smaller than the symbols used to display the measurements.}
