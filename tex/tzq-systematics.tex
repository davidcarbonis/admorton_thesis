...
A number of MC samples however, do not store the PDF weights as part of the event's LHE header	

\subsection{Factorisation and renormalisation scales}
The factorisation and renormalisation scales used at the Matrix Element and Parton Shower levels are 

ME - event level info
PS - dedicated samples
