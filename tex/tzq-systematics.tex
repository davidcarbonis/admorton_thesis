...
The main weakness of BDTs however, is their potential sensitivity to \emph{overtraining} or \emph{overfitting}.
...
The Adaptive Boost (\emph{AdaBoost}) algorithm is one of the most popular boosting algorithms
