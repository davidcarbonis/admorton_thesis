...
%\begin{figure}[ht]
%\centering
%\includegraphics[width=0.495\textwidth]{figs/background-estimation/simulationCorrections/electronLooseIdEff.pdf}
%\includegraphics[width=0.495\textwidth]{figs/background-estimation/simulationCorrections/electronTightIdEff.pdf}
%\caption{
%Electron identification efficiency in data (top) and data to MC efficiency ratios (bottom) measured for the tight (left) and loose (right) cut-based identification criteria. The efficiency is measured with the tag and probe method and shown in five pseudorapidity ranges as a function of the electron transverse momentum~\cite{CMS-DP-2017-004}.
%}
...
%\begin{figure}[ht]
%\centering
%\includegraphics[width=0.7\textwidth]{figs/background-estimation/simulationCorrections/tightMuonIdIsoEff.pdf}
%\caption{
%Electron identification efficiency in data (top) and data to MC efficiency ratios (bottom) measured for the tight (left) and loose (right) cut-based identification criteria. The efficiency is measured with the tag and probe method and shown in five pseudorapidity ranges as a function of the electron transverse momentum\cite{Sirunyan:2018fpa}.
%}
...
%Since the publication of the above search, as the background with the largest cross section uncertainty was covered by an uncert of 10\%, it is now CMS policy to assume an uncertainty of 10\%~\cite{crossSectionSystematics}.
