...
For all the MC samples considered, the hadronisation performed was undertaken using PYTHIA 8.
...
From a high-purity sub-sample of these events, where the dilepton invariant mass lies within tjhe window $60 < m_{ll} < 120 \GeV$, the lepton that passes a tight selection criteria is ``tagged'' and other lepton is ``probed'' against a loose selection criteria.
