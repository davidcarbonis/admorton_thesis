...
% This right-aligns numbers in column, but centers them under column title.
 \begin{tabular}{cccc}
   ...
   \hline
   tHq  & 3.5M & 0.07462  & MADGRAPH5\_aMC@NLO 2.2.2 (L) \\
   \hline
...
Simulation is unable to fully recreate all the effects observed in data corrective scale factors were used to reweight MC samples on a per event basis to account for possible discrepancies.

These scale factors were used to correct the simulation for any discrepencies in the lepton identification, isolation and reconstruction efficiencies, lepton and jet energy scales and resolutions, b-tagging efficiencies, the poor modelling of pileup in simulation, and the detector resolutions observed in data.
...
As the trigger requirements were applied to both simulated and data events, a scale factor of the ratio of the trigger efficiency in data and in simulation was calculated and used to weight the simulation.
...
%% new corrections plots
\includegraphics[width=0.47\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_LO/cutFlow_log.pdf}
\includegraphics[width=0.47\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_mumu_LO/cutFlow_log.pdf}
\\
%% old submission plots
...
%% new corrections plots
\includegraphics[width=0.47\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_NLO/cutFlow_log.pdf}
\includegraphics[width=0.47\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_mumu_NLO/cutFlow_log.pdf}
\caption{
...
%% new corrections plots
\includegraphics[width=0.47\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_mumu_LO/numbJets_SingleTop_lepSel_mumu.pdf}
\includegraphics[width=0.47\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_mumu_NLO/numbJets_SingleTop_lepSel_mumu.pdf}
\caption{
...
%% new corrections plots
\includegraphics[width=0.45\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_LO/leadingJetPt_SingleTop_jetSel_ee.pdf}
\includegraphics[width=0.45\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_NLO/leadingJetPt_SingleTop_jetSel_ee.pdf}
\\
%% old submission plots
...
%% new corrections plots
\includegraphics[width=0.45\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_LO/secondJetPt_SingleTop_jetSel_ee.pdf}
\includegraphics[width=0.45\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_NLO/secondJetPt_SingleTop_jetSel_ee.pdf}
\\
%% old submission plots
...
%% new corrections plots
\includegraphics[width=0.45\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_LO/thirdJetPt_SingleTop_jetSel_ee.pdf}
\includegraphics[width=0.45\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_NLO/thirdJetPt_SingleTop_jetSel_ee.pdf}
\\
%% old submission plots
...
%% new corrections plots
\includegraphics[width=0.45\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_LO/fourthJetPt_SingleTop_jetSel_ee.pdf}
\includegraphics[width=0.45\textwidth]{figs/background-estimation/plots/unblinded_corrections/DY_control_old_prompt_ee_NLO/fourthJetPt_SingleTop_jetSel_ee.pdf}
\caption{
...
% This right-aligns numbers in column, but centers them under column title.
 \begin{tabular}{cc}
   ...
   \hline
	...
	ttZ\@: & 12.87$\pm$0.15   \\
	ttH\@: & 10.27$\pm$0.14  \\
	\ttbar: & 3841.50$\pm$34.40   \\
	tW\@: & 158.13$\pm$5.13   \\
	s-channel\@: &  0.0$\pm$0.0 \\
	t-channel\@: & 1.22$\pm$0.29 \\
	WW\@: & 3.65$\pm$0.86  \\
	WZ\@: & 1.03$\pm$0.25 \\
	ZZ\@: & 0.19$\pm$0.03 \\
	WWW\@: & 0.29$\pm$0.09     \\
	...
	Z+jets\@: & 0.0$\pm$0.0     \\
	\hline
	Total MC\@: & 4043.78$\pm$27.29     \\
	\hline
	Data\@: & 4184.0$\pm$64.68     \\
   \hline
 \end{tabular}
\end{table}
...
When comparing the trigger efficiencies in simulation between the \ttbar and Z+jets samples, it was found that the differences between the trigger efficiencies in each channel was covered by the statistical uncertainties.
...
The CMS Collaboration's search for tZq production using the trilepton channel at $\sqrt{s} = 13\TeV$ assumed a value of 30\% for this source of systematic uncertainty, which reflected the theoretical uncertainties in the corresponding cross sections and a scaling up of a factor of two or more to account for possible modelling limitations~\cite{Sirunyan:2017nbr}.
Since the publication of the above search, it is now CMS policy to assume an uncertainty of 10\%.
...
These rates, whilst giving an overview of which systematics were the most important, do not show how the shape of the fitted variable, the BDT discriminant, is influenced by each uncertainty.

Prior to performing the likelihood fit described in Chapter~\ref{chapter:results}, the theoretical sources of uncertainty were observed to have the greatest impact on the observed yields of the simulated samples.
...
The output distributions were binned using a recursive binning strategy that ensured that each bin contained at least one background event and that the statistical error did not exceed 10\% for either signal or background~\cite{combineBinning}.
These conditions were recommend by the developers of the statistical analysis framework used to extract the signal strength and its statistical significance to ensure bins contained sufficient statistics to avoid causing:
\begin{itemize}
...
\caption{
Pre-fit distributions of the BDT discriminant for the $ee$ channel (top) and $\mu\mu$ channel (bottom). The }
\label{fig:prefitBDT}
\end{figure}
