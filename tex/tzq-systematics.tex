...
\emph{Overtraining} or overfitting = over optimisations on the training data set resulting in poor classification of unseen data.
...
Out of these averaged final metrics, the classifier with the best $(\theta)$ was retrained on all the training data, checked against the training data, and if satisfactory, used to produce the optimal BDT.
