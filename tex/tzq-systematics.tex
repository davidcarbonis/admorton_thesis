...
%The electron tight identification and isolation working point's efficiency measured in 2016 data and the corresponding data/simulation scale factors as a function of \pT for different $\eta$ ranges are shown in Figure~\ref{fig:electronIdEff}. 

%Despite the miscalibration of the tracker APV chips during 2016, high muon identification, isolation and reconstruction efficiencies are typically achieved for all working points and are well described by simulation.
%As shown in Figure~\ref{fig:tightMuonIdEff}, the tight identification and isolation working points for muons with $\pT > 20\GeV $was measured to be greater than 95\% across all $\eta$ for 13\TeV proton-proton collisions in 2015 and the agreement between data and simulation was better than 0.5\%~\cite{Sirunyan:2018fpa}.
%
%\begin{figure}[!ht]
%\centering
...
%\caption{
%Muon tight identification and isolation efficiency in data and MC (top) and data to MC efficiency ratios (bottom) measured for the tight identification and isolation criteria as a function of \pT (left) and $\eta$ (right)~\cite{DP-2017-007}.
%}
