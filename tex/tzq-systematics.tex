...
The trigger efficiencies determined for the \ttbar and Z+jets simulation samples the $ee$ and $\mu\mu$ final states are shown in Table~\ref{tab:zPlusTriggerSFs}.
Distributions of the trigger efficiencies for the \ttbar and Z+jets simulation samples as functions of $\pT$ and $\eta$ are provided in Appendix~\ref{appSec:triggerSystPlots}.
...
Since the publication of the above search, it is now CMS policy to assume an uncertainty of 10\%~\cite{crossSectionSystematics}.
This decision was deemed 
% The background with the largest xc uncert was more than covered by an uncert of 10\%. This was further justified in that  
