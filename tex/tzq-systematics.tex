...
The Madgraph sample was observed to poorly describes higher jet multiplicities but the overall sample normalises correctly, whilst the aMC@NLO better describes the shape of higher jet multiplicities but experiences an offset scale.
...
To find the minima of such a black box function, the \emph{Scikit-Optimize} library was used to constract a regression model based on a Gaussian process with the Mat\'{e}rn kernel~\cite{scikit-optimise}.
This process initially 


In order to validate the quality of the classifiers found 
