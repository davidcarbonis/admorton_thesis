...
The impact of the each of the systematics on the event yield (in percentage) of the simulated processes following the application of the signal region selection criteria is shown in Table~\ref{tab:systImpact}.
...
\topcaption{Rate impact of systematics on MC}\label{tab:systImpact}
\begin{center}
\linespread{2}
