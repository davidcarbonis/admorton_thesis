...
Despite applying the event selection described in Chapter~\ref{} to reduce the background

The \emph{Boosted Decision Tree}~(BDT) MVA technique is used for the search presented in this thesis as it a widely used and supported technique which those undertaking this analysis were familiar with.
