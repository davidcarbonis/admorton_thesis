...
The Jet Energy Correction group also determines the uncertainties associated with the JECs, discussed in Chapter~\ref{subsubsec:JECs}, which they calculate. 
Jet Energy Scale (JES) - SF moved up/down by one s.d.
Jet Energy Resolution (JER) - s.d.  of Gaussian fitted to detector's jet response.
Accounted for bysmearing the jet 4-vector as function of its true and reco \pt and $\eta$, with the variation of applied up/down 
...
The factorisation and renormalisation scales used at the Matrix Element level are 
