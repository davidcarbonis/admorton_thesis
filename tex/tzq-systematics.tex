...
\begin{tabular}{cccc}
   ...
   \hline
    ...
    thirdJetPt & $\eta$ of the second W boson candidate jet & $X$ \\
    thirdJetPhi & $\Delta R$ between the W boson candidate jets & $\checkmark$ \\
    thirdJetEta & $\eta$ of the Z boson & $X$ \\
    thirdJetbTag & \HT of the Z boson & $\checkmark$ \\
    fourthJetPt & $\eta$ of the second W boson candidate jet & $X$ \\
    fourthJetPhi & $\Delta R$ between the W boson candidate jets & $\checkmark$ \\
    fourthJetEta & $\eta$ of the Z boson & $X$ \\
    fourthJetbTag & \HT of the Z boson & $\checkmark$ \\
