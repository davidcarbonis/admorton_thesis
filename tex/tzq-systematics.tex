...
It was observed that while the event yields in the signal region were correctly described when the Madgraph sample was used, with there aMC@NLO sample there was a dramatic normalisation offset.
