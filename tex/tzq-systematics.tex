...
Using Van der Meer (VdM) scans during dedicated LHC runs to calibrate the absolute luminosity scale calibrations of the detectors, the overall uncertainty in the integrated luminosity measured by CMS in 2016 was estimated to be 2.5\%~\cite{CMS:2017_lumi}.
