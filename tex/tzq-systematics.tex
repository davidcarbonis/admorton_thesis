...
The efficiency measured using $13\TeV$ proton-proton collisions in 2016 and the differences between simulation and data for the electron cut-based identification's tight working point is shown in Figure~\ref{fig:electronIdEff} in five $\eta$ ranges as a function of \pT.
The efficiency tight identification working point decreases for low \pT electrons 

The efficiency of the loose and tight identification working points for muons are shown Figure~\ref{fig:tightMuonIdEff}~\cite{DP-2017-007}.
The loose identification working point's efficiency in 2016 data was found to be greater than 98\% across all $\eta$ and data and simulation agree to within 1\%.
...
Figure~\ref{fig:tightMuonIdEff} shows the tight isolation efficiency for muons with $\pT > 20\GeV$ that have passed the tight identification criteria~\cite{DP-2017-007}.
...
\caption{
The muon loose (left) and tight (right) identification working points' efficiencies for $13\TeV$ proton-proton collisions in 2016 and simulation (top) and data to simulation efficiency ratios (bottom) measured as a function of $\eta$~\cite{DP-2017-007}.
}
...
\caption{
The muon tight isolation efficiency for the tight identification working point for $13\TeV$ proton-proton collisions in 2016 and simulation (top) and data to simulation efficiency ratios (bottom) measured as a function of \pT (left) and $\eta$ (right)~\cite{DP-2017-007}.
}
