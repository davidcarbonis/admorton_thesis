...
Two types of energy corrections that have been produced by the CMS ElectronGamma (EGM) Physics Object Group are applied to electrons and photons, namely energy regression and energy scale and smearing corrections.
These corrections use $Z \rightarrow e^{+} e^{-}$
