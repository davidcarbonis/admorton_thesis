...
This smaller value was decided upon as it covered the scaling of the two dominant background processes by a factor or two or more and there was in increased confidence in the theoretical modelling of the backgrounds considered given the improved precision of their cross section measurements since the trilepton search was made~\cite{combineNick,crossSectionSystematics}. 
