...
As having a NLO description of this large multi-jet background was highly desirable given the event selection, it was decided to use nominal Z+jets control region to determine the correct normalisation of the aMC@NLO Z+jets samples.
