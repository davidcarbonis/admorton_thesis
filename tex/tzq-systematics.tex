...
Therefore by extending boosting to decision trees, the resultant forest of \emph{Boosted Decision Trees} provides much more effective classifier than a single tree.
...
The Adaptive Boost (\emph{AdaBoost}) algorithm is one of the most popular boosting algorithms used 
...
Following a series of studies into evaluating:

\begin{itemize}
\item a number of Boosting and Bagging algorithms for decision trees;
