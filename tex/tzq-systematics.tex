...
% This right-aligns numbers in column, but centers them under column title.
 \begin{tabular}{cccc}
   ...
   \hline
   t s-channel & 2.9M & 10.32 & MADGRAPH5\_aMC@NLO 2.2.2 (NLO) \\
   \hline
...
Source &  $ee$ & $\mu\mu$  \\ 
\hline
$N_{\ttbar}^{SS}$ & 29.45$\pm$3.03 & 72.77 $\pm$4.89   \\
$N_{\ttV}^{SS}$ & 6.80$\pm$0.08 & 10.479   \\ 
$N_{single top}^{SS}$: & 2.29$\pm$0.04 & 2.17 $\pm$    \\
$N_{W+jets}^{SS}$: & 0.0$\pm$0.0 & 0.0 $\pm$ 0.0  \\
$N_{Z+jets}^{SS}$: & 44.72$\pm$7.56 & 0.0 $\pm$ 0.0  \\
$VV^{SS}$ & 2.12$\pm$.12 & 0.348  \\
$VVV^{SS}$ & -0.02$\pm$0.01 & 0.098 \\
\hline
$N_{MC}^{SS}$ background & 95.36$\pm$8.21 & 85.088  \\ 
$N_{data}^{SS}$ & 126.0 $\pm$ 11.22 & 125.0  \\ 
\hline
$N_{data}^{SS} - N_{MC}^{SS}$: & 30.64 & 39.912 \\
\hline
$N_{MC}^{OS non-prompt}$: & 1.579 & 2.379 \\
$N_{MC}^{SS non-prompt}$: & 1.705 & 2.135 \\
$N_{MC}^{OS non-prompt}/N_{MC}^{SS non-prompt}$: & 0.926 & 1.114 \\
\hline
...
In contrast however, the LO Z+jets sample not only correctly describes the normalisation of the LO sample, but also the jet multiplicities throughout the application of the selection criteria and simulation corrections.
...
Before the NLO Z+jets sample can be considered in future, the reasons why it does not correctly normalise and poorly describes events with low jet multiplicities will need to be understood.
...
The selection criteria produce an enriched region where 97.5\% of the expected events are from \ttbar production.
