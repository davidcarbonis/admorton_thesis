...
While jet cleaning and tight isolation criteria for leptons has significantly reduced the non-prompt lepton contributions, completely removing the W+jets process,

It is clear that while the high purity selection criteria rejects the majority of the Z+jets events, it remains the dominant background. 
Dilepton \ttbar events consistent with a Z
The 
...
In the signal region, the Madgraph sample was observed to poorly describe higher jet multiplicities but 
...
Both of the Z+jets control regions defined in Chapter~\ref{subsec:zPlusJetsCR} were used to validate whether 

Given that the aMC@NLO sample better describes the higher order contributions for this process, the 
...
Following the full control region event selection, both the overall yields given in Table~\ref{tab:ttbarCR}, and the kinematics of the two leptons and the four leading jets given in Figures~\ref{}, show consistently good agreement between simulation and data.
