...
A constant scale factor was found to be sufficient to account for the differences in the trigger efficiency between data and simulation for the $ee$, $\mu\mu$ and $e \mu$ final states considered for.
