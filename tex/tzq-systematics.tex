...
This involves training multiple trees in succession on the same training sample, where each new tree takes the performance of the past trees into account.
...
The \emph{Gradient Boost} algorithm~\cite{Friedman:GradientBoosting}  


Adaboost adds higher weights to misclassified events to modify the performance of subsequent trees to obtain a better separation.
The } models the shortcomings of the model by estimating the regression function 
