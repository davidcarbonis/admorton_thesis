...
The resultant output discriminant distributions are shown in Figure~\ref{fig:prefitBDT} 
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.97\textwidth]{figs/results/prefit_ee.pdf}
\\
\includegraphics[width=0.97\textwidth]{figs/results/prefit_mumu.pdf}
\caption{
