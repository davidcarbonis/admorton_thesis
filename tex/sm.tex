...
At first glance, given the large \ttbar production cross section,

the natural starting point to probe the top-electroweak sector might involve the study of pair produced top quarks in association with an electroweak boson, given the .
When considering the topologies of the final states for both pair and singly produced top quarks in association with an electroweak boson however, things are not as straightforward.

Probing the top quark and W boson coupling can only be done with single produced top quarks, given that for \ttW the W boson couples to the initial state quarks, as illustrated in figure~\ref{fig:feyn_ttV}.
 the top quark couplings to the photon, Higgs and Z bosons can be accessed through singly and pair produced top quarks.
...
With the high centre-of-mass proton-proton collision energies accessible at the LHC,
The production of a single top quark in association with a $\text{Z}^0$ boson with an additional jet, known as \emph{tZq}, is a unique probe of the SM. 
...
%\begin{figure}[h]
%\centering
%\includegraphics{figs/sm/tzq/TplusZtot.pdf}
%\caption{The next-to-leading order cross section for single top and top pair prodcution with and without an associated Z boson.~\cite{Campbell:2013yla}.
%}
%\label{fig:topCrossSections}
%\end{figure}
