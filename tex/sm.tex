...
In the SM there are four gauge bosons, each of which is an integer spin particle that mediate the weak, strong and electromagnetic forces. 
...
Quantum Chromodynamics (QCD) is the theory which describes the Strong force.
...
The existence of the top quark was first hypothesised in 1973 by Makoto Kobayashi and Toshihide Maskawa as 

The length of time between being theorised and its discovery 
...
Following the discovery of the bottom quark and the tau lepton -> symmetry = top to complete the quark doublet

bottom quark 1977~\cite{Herb:1977ek}
...
Discovered by CDF and D\O at the Tevatron~\cite{Abe:1995hr,D0:1995jca}
...
Top quark pair-production (\ttbar) is the predominant production mechanism at colliders.
At leading order (LO) 
 as illustrated in the leading order (LO) Feynman diagrams 
Top quarks are predominately produced by pair-production at hadron colliders through the Strong Force, as illustrated in Figure~\ref{fig:feyn_ttbar}.
...
Top quarks can also be produced singly through weak interactions, 

providing a powerful probe between the top quark and electroweak sector allowing for precision measurements of SM parameters whilst being sensitive to new physics, such as anomalous couplings.
As 
...
Singly produced top quarks are produced through three differing channels, as shown in Fig.~\ref{fig:feyn_singletop}).
