...
In this chapter, the Standard Model (SM) of particle physics introduced	


The current fundamental model of reality is the Standard Model (SM).
The SM is a theory which describes  through a renormalisable \cite{LagrangiansSM}.


\section{The Standard Model}\label{sec:sm}

The Standard Model (SM) of particle physics is the current fundamental model of reality which describes 
