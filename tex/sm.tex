...
% This right-aligns numbers in column, but centers them under column title.
 \begin{tabular}{lcccc}
   ...
   \hline
   \multirow{2}{*}{Gluon ($g$)} & \multirow{2}{*}{$0$} & \multirow{2}{*}{$0$} & $r \overline{g}$, $r \overline{b}, g \overline{r}, g \overline{b}, b \overline{r}, b \overline{g} $ \\
   & & & &  $\frac{1}{\sqrt{2}}(r \overline{r} - g \overline{g}), \frac{1}{\sqrt{6}}(r \overline{r} + g \overline{g} - 2 b \overline{b})$ & \multirow{2}{*}{$0$} \\
   \hline   
 \end{tabular}}
\end{table}	
