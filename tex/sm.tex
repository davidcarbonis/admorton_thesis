...
The current fundamental model of reality is the Standard Model (SM).
The SM is a theory which describes the fundamental matter particles of nature, fermions, and their interactions with the weak, strong, and electromagnetic forces through a renormalisable \cite{LagrangiansSM}.
...
Despite the incredible success of the SM in terms of both its predictive powers and 

known fundamental particles 
it SM is far from being a complete theory. 
There are many problems that the SM cannot resolve 
