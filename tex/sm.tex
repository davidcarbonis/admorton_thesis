...
All matter is described as spin-$\frac{1}{2}$ particles known as fermions and are classified as 




and the forces by spin-$1$ bosonic fields
...
% This right-aligns numbers in column, but centers them under column title.
 \begin{tabular}{lllll}
   \hline
   \textbf{Force} & \textbf{Gauge Boson} & \textbf{Mass (\GeV)} & \textbf{Electrical Charge} & \textbf{Range (m)}  \\
   \hline
   Electromagnetic & photon ($\gamma$) & $0$ & $0$ & $\infty$ \\
   \multirow{3}{*}{Weak} & $\text{W}^{\pm}$ & $80.385 \pm 0.015$ & $\pm 1$ & $10^{-18)$ \\
   & $\text{Z}^{0}$ & $91.1876 \pm 0.0021$ & $0$ & $10^{-18)$ \\
   Strong & 
   Gravity & ? & ? & ? & $\infty$ \\
   \hline   
 \end{tabular}}
