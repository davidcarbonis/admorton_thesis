...
As the top quark has the largest mass of any fundamental particle, it has the strongest coupling to the Higgs field, many have conjectured that the top quark has a special role to play in  electroweak symmetry breaking~\cite{}.
...
While approximately 90\% of \ttbar events produced at the Tevatron occured via quark fusion, 80-90\% of \ttbar events at the LHC are produced by gluon fusion for $\sqrt{s} = 8-14\TeV$~\cite{Patrignani:2016xqp}.
...
The discovery of the tW-channel was particularly anticipated as the presence of the on-shell W boson in the final state makes it an excellent probe of the Wtb vertex and the theoretical challenges in describing its   interference with \ttbar production at next-to-leading order.
