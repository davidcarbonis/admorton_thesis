...
With the LHC producing unprecedented levels of top quarks, the statistics have become available to not only study singly and pair produced top quarks, but also to prove the top quark and electroweak sector.

The production of a single top in association with a \Z0 boson with an additional jet, \emph{tZq}, 
...
Decay modes:
Given the small cross section of the process and 
During Run I of the LHC a search for the fully leptonic \emph{trilepton} final state containing three leptons (\emph{trileptonic})
