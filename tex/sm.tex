...
% This right-aligns numbers in column, but centers them under column title.
 \begin{tabular}{llllccc}
   ...
   \hline
   \multirow{3}{*}{Quarks}  & \multirow{2}{*}{I} & up (\textit{$u$})  & 2.3 & $+ \frac{2}{3}$ & $+ \frac{1}{2}$ \\
...
% This right-aligns numbers in column, but centers them under column title.
 \begin{tabular}{lcccc}
   ...
   \hline
   \multirow{2}{*}{Gluon ($g$)} &$0$ & $0$ & $0$ & $r \overline{g}$, $r \overline{b}, g \overline{r}, g \overline{b}, b \overline{r}, b \overline{g} $ \\
...
The violation of CP symmetry results in weak interactions occurring for matter and anti-matter occurring at different rates, partially accounting for the observed matter-anti-matter asymmetry in the universe.
...
A direct consequence of asymptotic freedom is that quarks are confined t
...
In contrast to \ttbar, these processes allow for the Wtb vertex to be probed for the production of top quarks as well as their decay 
 Wtb vertex allows for the direct measurement of the $\abs{V_{tb}}$ element of the Cabibbo-Kobayashi-Maskawa (CKM) matrix and thus test whether the CKM matrix is unitary as presumed or otherwise~\cite{Shibata:2008sy}.
...
\item Precision measurements of these processes can be used to compliment \ttbar production in constraining Parton Distribution Functions~\cite{Guffanti:2010yu}.
\end{itemize}
...
The high centre-of-mass energies and integrated luminosities available at the LHC have made it possible to 
...
Although it may be initially assumed studying the electroweak interactions of the top quarks would be easisthrough hadronically produced top quarks 


, that they would be considerably more difficult to probe the top-electroweak sector through single top quark production processes.
The tW coupling however, can only be probed through the single top tW-channel given that the W boson couples to the initial state quarks for \ttW, as illustrated in Figure~\ref{fig:feyn_ttV}.
tHq production has yet to be observed~\cite{CMS:2018jsz} as it is much more difficult to access than \ttH prodution due to the destructive interference between the tH and HW vertices~\cite{Maltoni:2001hu}.
...
In contrast, \ttZ production has a lower production cross section than the combined cross sections for the prodution of a single top (tZ) or anti-top quark in association with a Z boson ($\overline{\text{t}}$Z)~\cite{Campbell:2013yla}.
...
tZq production is a rare SM process that provides a unique precision probe of electroweak interactions of the top quark as it
