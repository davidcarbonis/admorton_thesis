...
Eventually it becomes more energetically favourable for additional quarks to be created from the vacuum rather than to separate the quarks any further.

Consequently, quarks can only exist only in colour-singlet states and are said to be \emph{colour confined}~\cite{ElectroweakStrong,Griffiths,devenish2004deep}.
This process of producing new hadrons 



As colour confinement prevents the direct observation of a hadron's constituent partons, the structure of hadrons is studied through scattering processes, such as Deep Inelastic Scattering.
...
As perturbation theory can be used when $\alpha_{s}$ is much smaller than one, \ie at high energies, QCD calculations are factorised at a given energy scale into perturbative and non-perturbative components.
...
\begin{equation}
\sigma ( \textrm{tZq}, Z \rightarrow l^{+} l^{-}) = \textrm{94.2} \;
