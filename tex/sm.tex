...
While tH is much more difficult to access than \ttH due to the destructive interference between the tH and HW vertices~\cite{Maltoni:2001hu}, this is not the case for the \ttZ and tZ.
Despite the relative strength of the strong coupling, the large number of particles present in the \ttZ final state suppresses its production to the extent that \ttZ has a lower production cross section than the combined tZ and \overline{\text{t}}Z cross section~\cite{Campbell:2013yla}.
...
CMS has made measurements in excess of five standard deviations for \ttH, \ttW, and \ttZ~\cite{Sirunyan:2017uzs,Sirunyan:2018hoz}, all of which were consistent with the SM.
Only the tW-channel has been discovered by CMS to date, 
discovery
tH - CMS:2018jsz

Given that CMS was capable of observing \ttZ was using Run-I data~\cite{Khachatryan:2014ewa}, a search for tZq was undertaken by CMS which made a measurement with a siginifiance of 2.9 standard deviations~\cite{Sirunyan:2017kkr}. 
...
The analysis presented in this thesis is the search for the a single top quark produced in association with a $\text{Z}^0$ boson with an additional jet, known as \emph{tZq}.

tZq 

Of these processes, the analysis presented in this thesis is the search for a single top quark produced in the t-channel in association 
tZq is a single top production in the t-channel, where a $\text{Z}^0$ boson is radiated off one of the quark legs, as shown in figures~\ref{fig:feyn_tZq}(a)-(e), or from the exchanged W boson, as shown in figure~\ref{fig:feyn_tZq}(f).
...
Previously the only final state searched fully leptonic final state of tZq have been searched for
