...
Quantum Electrodynamics (QED) is the incredibly successful theory based on the $U(1)_{EM}$ gauge group which describes the electromagnetic force. 
These interactions

$U(1)_{EM}$ gauge group only has a single generator which self-commutes, the single vector field
