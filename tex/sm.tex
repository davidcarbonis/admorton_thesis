...
Consequently 
This behaviour of $\alpha_{s}$ results in the \emph{colour confinements} quarks being 
Consequently, quarks are  to exist in colour-singlet states ~\cite{ElectroweakStrong,Griffiths,devenish2004deep}.

In high energy hadron collisions, such as those at the LHC, the liberation of partons from their constituent hadrons is a common occurrence.

These new quarks and the separated quarks form new hadrons in a process known as hadronisation~\cite{Andersson:1983ia}.


In QED, higher order processes contribute less to the Matrix Element due to the alpha EM -ve
In contrast however, higher order contributions in QCD become increasingly important as $\alpha_{s}$ increases. 
