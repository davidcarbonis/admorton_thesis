...
This allows for the short distance components to be described using perturbation theory, such as the hard scattering of hardons, while the long distance components are described using non-perturbative models, such as Parton Distribution Functions (PDFs).
PDFs describe the number density of a hadron's partons carrying a momentum fraction $x$ at a given energy scale and are constrained by experimental measurements made by various experiments~\cite{Ball:2014uwa,devenish2004deep,}.
