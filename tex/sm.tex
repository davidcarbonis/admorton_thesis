...
The liberation of partons ...
These new quarks and the separated quarks form new hadrons in a process known as hadronisation.


In QED, higher order processes contribute less to the Matrix Element due to the 
In contrast however, QCD 


Demonstrated that QCD calculations can be temporally split into long and short distance behaviours
