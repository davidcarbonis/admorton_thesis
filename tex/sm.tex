...
These concepts can be demonstrated by considering applying the $U(1)$ gauge symmetry of Quantum Electrodyanmics (QED), the theory of electromagnetism, on the Lagrangian of a relativistic spin-$\frac{1}{2}$ free-fermion field (\ie electrons) with a wavefunction $\psi(x)$ and particles of mass $m$~\ref{eq:diracLagrangian,QFT}:
...
Quantum Electrodynamics (QED) is the theory based on the $U(1)_{EM}$ gauge group which describes the electromagnetic force. 
As the $U(1)_{EM}$ gauge group only has a single generator which self-commutes,  
...
Weak interactions are mediated by the massive W$^{\pm}$ and Z$^{0}$ bosons 	
...
The unification of the electromagnetic and weak forces into a single \emph{electroweak} interaction
 ...
 described by the $SU(2)_{weak isospin} \times U(1)_{hypercharge}$ gauge group was independently developed by Abdus Salam and Steven Weinberg based on ...
