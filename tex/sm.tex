...
Unlike the other five quarks, the top quark is massive enough to decay into an on-shell W boson 

As the top quark's mass is greater than that of the W boson, it capable of decaying into an on-shell W boson and a down-type quark, giving it a much shorter lifetime than the other quarks
This 
...
As the top quark decays into a W boson and a b-quark, the three different decay modes of pair produced top quarks are characterised by the manner in which the two W bosons decay:
\begin{itemize}
...
Although it may be initially assumed that, given the larger production cross section for \ttbar production compared to single top processes, it would be considerably more difficult to probe the top-electroweak sector through single top quark production processes.
