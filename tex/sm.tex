...
PDFs describe the number density of a hadron's partons carrying a momentum fraction $x$ at a given energy scale and are determined 
 fit $x$ for a given energy scale.
