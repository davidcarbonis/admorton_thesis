...
A direct consequence of asymptotic freedom is the phenomenon known as \emph{colour confinement}, whereby quarks cannot exist outside of bound colourless states.
As increasingly large amounts of energy are required to increase the separation between quarks, it eventually becomes more energetically favourable for additional quarks to be created from the vacuum to accompany the separated quarks to form hadrons.
