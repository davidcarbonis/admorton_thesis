...
As discussed in Section~\ref{subsec:weakForce}, the W$^{\pm}$ gauge bosons only interact with the left-handed components of fermion fields.
Under the $SU(2)_{L}$ group of transformations, the left-handed fermion fields, $\psi_{L}$, transform as doublets and the right-handed fermion fields, $\psi_{R}$, as singlets.

The charged weak gauge bosons 
