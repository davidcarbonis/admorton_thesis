...
%%% Intro
The SM describes the electromagnetic and weak forces with a unified \emph{electroweak interaction} that was formulated by Glashow, Salam and Weinberg~\cite{Glashow:1961tr,Salam:1964ry,Weinberg:1967tq}.
The electroweak force is described by the $SU(2)_{weak isospin} \times U(1)_{hypercharge}$ gauge group.
The electroweak theory was  and is based on .
and hypotheses that above a unification energy the electromagnetic and weak forces can be described by a single electroweak force.
