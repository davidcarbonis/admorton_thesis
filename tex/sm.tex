...
Under $SU(2)_{L}$ transformations, these gauge fields only act upon the left-handed component of the fermion field, $\psi_{L}$ 	

the left-handed fields, $\psi_{L}$, transform as doublets and the right-handed fields, $\psi_{R}$, as singlets.
