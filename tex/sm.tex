...
The SM is a Quantum Field Theory (QFT) where 


based on the $SU(3)_{C} \times SU(2)_{L} \times U(1)_{Y}$ symmetry group where the interactions of the fermonic fields 
