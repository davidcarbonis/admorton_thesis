...
Consequently, quarks are \emph{colour confined} and can only exist in colour-singlet states~\cite{ElectroweakStrong,Griffiths,devenish2004deep}.
...
At sufficiently high energies, such as the hard process
As such, for a given factorisation scale, QCD calculations are separated 
