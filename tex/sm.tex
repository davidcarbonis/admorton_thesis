...
As shown by Emmy Noether's theorm, any such symmetry has a corresponding conserved quantity~\cite{Noether:1918zz}.



Examples of such invariant or conserved quantities include electrical charge from the $U(1)$ gauge group’s symmetry in electromagnetism, energy-momentum from space-time symmetry and angular momentum from rotational symmetry. 
