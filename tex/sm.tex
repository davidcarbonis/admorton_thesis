...
The initial searches for tZq however, used the trilepton final state as despite it having a smaller production cross section than either of the dilepton or hadronic final states, it is the easiest to separate from background processes.
