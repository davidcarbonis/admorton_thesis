...
While only the single top tW-channel provides a probe between the top quark and W boson, as as illustrated in figure~\ref{}, the top quark couplings to the Higgs and Z bosons can be accessed through singly and pair produced top quarks.

The production of a single top quark in association with a $\text{Z}^0$ boson with an additional jet, \emph{tZq}, is a rare SM process that is based on single top production in the t-channel.
...
ttH vs tH - tH lower due to destructive interference between HW and tH vertices Maltoni:2001hu

it might be assumed that given the high cross section for \ttbar production that 
