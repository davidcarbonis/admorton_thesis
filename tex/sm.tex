...
%%% Intro
In the SM the electromagnetic and weak forces are described by the \emph{electroweak theory} that is based on the $SU(2)_{weak isospin} \times U(1)_{hypercharge}$ gauge group.
The electroweak theory was formulated by Glashow, Salam and Weinberg~\cite{Glashow:1961tr,Salam:1964ry,Weinberg:1967tq} hypotheses that above a unification energy the electromagnetic and weak forces can be described by a single electroweak force.
