...
These four gauge fields are related to the four physical gauge bosons observed 
...
The Higgs mechanism introduces a complex scalar field, known as the \emph{Higgs field}, which has a potential with a non-zero vacuum expectation value (VEV).
While VEV itself  
Ellis:2013jnq
...
This mechanism also imparts Fermions also 
