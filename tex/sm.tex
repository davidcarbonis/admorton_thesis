...
The high centre-of-mass energies and integrated luminosities available at the LHC have made it possible to not only undertaken not only measurements of processes involving the tZ vertex, but other electroweak interactions of the top quark.
...
In contrast, not only is the cross section 
The tZ coupling can be probed with both \ttZ and 
