...
%Fermions are half-integer spin particles (i.e. s = $\pm\frac{1}{2}, \pm\frac{3}{2},\pm\frac{5}{2}$,…) which have three so-called ``generations'', and belong to one of two families: quarks and leptons. 
...
The SM is arenormalisable Quantum Field Theory (QFT) based on the $SU(3)\times SU(2) \times U(1)$ symmetry group~\cite{LagrangiansSM}.
...
The top quark's mass of $173.44 \pm 0.51 \pm 0.71 \GeV$ makes it the most massive known fundamental particle and 

Many of its properties, stemming from its mass of $173.44 \pm 0.51 \pm 0.71 \GeV$ and short lifetime, have no equivalent for the other five quarks~\cite{LHC:2014combination}. 

Comment on lifespan - add diagram for decay modes. Comment on what it decays into.

In contrast to the other quarks, 
...
With the LHC's centre-of-mass energy and instantaneous luminosity being 
...
While \ttbar production at the Tevatron was dominated by quark fusion
...
These channels, despite their relatively small cross-sections compared to \ttbar, are important backgrounds which need to be understood in order to be able to probe for new physics with similar or smaller cross sections, such as $\ttH	$ or tZq~\cite{Khachatryan:2014ewa}.

\subsection{Single top quark production}\label{subsec:singleTopTheory}
Top quarks can also be produced singly through weak interactions, albeit 

providing a powerful probe between the top quark and electroweak sector.
This allows physicists the opportunity for precision measurements of SM parameters which are sensitive to new physics, such as anomalous couplings.
...
At leading order, the main SM single top production processes are categorised by the virtuality of the W boson involved in the interaction (see figure~\ref{fig:singleTopDiagrams}).
...
Despite this however, given the inability of the SM to address a number of experimental observations and to incorporate gravity, it is apparent that there must be physics Beyond the Standard Model (BSM).
