...
The top quark's mass, $m_{top}$, of $173.44 \pm 0.51 \pm 0.71 \GeV$ makes it the most massive known fundamental particle and is responsible for imbuing it with properties which have no equivalent for the other five quarks~\cite{LHC:2014combination}.
The mass of the top quark $m_{top}$ is greater than the mass of a W boson, making it capable of decaying into an on-shell W boson and a down-type quark and giving it a much short lifetime than the other quarks.
...
The down-type quark decay product has a probability of being a bottom
top quarks predominantly decay into a W boson and bottom quark at a ....


Since the
Given all these properties, the top quark is not only an excellent probe of the Wtb vertex and sensitive to any anomalous couplings that would impact it, but 


With the top mass being greater than that of any other fundamental particle, it has the strongest coupling to the Higgs field.
...
Understanding top quarks processes is also vital for other searches, as they form significant backgrounds for searches for new physics in the TeV range~\cite{Quadt}.
For while the top quark has not been studied to the same extent as the other quarks due to its later discovery and the relatively low top quark production rate at the Tevatron limiting statistics, 
...
The \Z0 boson is radiated off one of the quark legs, as shown in figures~\ref{fig:feyn_tZq}(a)-(e), or from the exchanged W boson, as shown in figure~\ref{fig:feyn_tZq}(f).
...
Despite the multitude of theories which been proposed to solve one or more of the problems with the SM briefly described above, currently 
