...
The analysis presented in this thesis is the search for a single top quark produced in association with a $\text{Z}^0$ boson with an additional jet, known as \emph{tZq}, for the dilepton final state.
