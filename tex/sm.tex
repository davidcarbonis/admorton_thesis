...
The theory of \emph{electroweak} interactions, formulated by Glashow, Salam and Weinberg~\cite{Glashow:1961tr,Salam:1964ry,Weinberg:1967tq}, is described by the $SU(2)_{weak isospin} \times U(1)_{hypercharge}$ gauge group and hypotheses that its two seemingly disparate constituent forces are described as a single electroweak force above a unification energy.


The $U(1)_{hypercharge}$ component of the theory has a single generator, and an associated gauge field $B_{\mu}$, which acts on and conserves weak hypercharge, $Y_{W}$.
...
The $SU(2)_{weak isospin}$ component of the theory has three generators, $\bm{T_{i}} = \frac{\bm{\sigma_{i}}}{2}$, which manifest as the gauge fields W, where $\bm{\sigma}$ are the pauli spin matrices and $i = 1, 2, 3$.
As discussed in Section~\ref{subsec:weakForce}, 

weak isospin is conserved by the $SU(2)$ transformations, the left-handed fields, $\psi_{L}$, transform as doublets and the right-handed fields, $\psi_{R}$, as singlets.
...
The $SU(2)_{isospin} \times U(1)_{hypercharge}$ ``electroweak'' symmetry is said to be ``broken''. 
