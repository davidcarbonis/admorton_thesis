...
\subsection{The Standard Model Lagrangian}\label{subsec:sm-langrangian}
...
\subsection{The Higgs Mechanism}\label{subsec:higgs}

\subsection{Beyond The Standard Model}\label{subsec:bsm}
...
Both the CMS and ATLAS experiments at CERN have independently confirmed the existence of an unknown boson at $\approx$ 125\GeV, which was later confirmed to be consistent with the Higgs Boson, the smallest possible excitation of its associated namesake field\cite{HiggsCMS}\cite{HiggsATLAS}. 
Searches to determine whether this is the SM Higgs or not (several theories including SUSY propose multiple Higgs\cite{Khalil:2003vd}\cite{Gianotti:2002xx}) will take place after the phase-0 upgrades of the LHC. 
...
\subsection{Top Physics}\label{subsec:top-physics}
