...
// ------------>Primitives in pad: canvy_2
   ...
   p_muonElectron2_eta_SF__6->GetXaxis()->SetLabelSize(0.10);
   ...
   p_muonElectron2_eta_SF__6->GetYaxis()->SetLabelSize(0.10);
   p_muonElectron2_eta_SF__6->GetYaxis()->SetTitleSize(0.12);
   p_muonElectron2_eta_SF__6->GetYaxis()->SetTitleOffset(0.4);
