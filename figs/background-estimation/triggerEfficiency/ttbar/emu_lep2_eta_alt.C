...
// ------------>Primitives in pad: canvy_1
   ...
   TProfile *muonElectron2_eta_MC = new TProfile("muonElectron2_eta_MC","",5, xAxis);
   ...
   muonElectron2_eta_MC->GetXaxis()->SetTitle(" Muon #eta");
   ...
   muonElectron2_eta_MC->GetYaxis()->SetTitle(" Trigger Efficiency");
   muonElectron2_eta_MC->GetYaxis()->SetLabelFont(42);
   muonElectron2_eta_MC->GetYaxis()->SetLabelFont(42);
   muonElectron2_eta_MC->GetYaxis()->SetLabelOffset(0.01);
   muonElectron2_eta_MC->GetYaxis()->SetLabelSize(0.056);
   muonElectron2_eta_MC->GetYaxis()->SetTitleSize(0.0645);
   muonElectron2_eta_MC->GetYaxis()->SetTitleOffset(0.785);
...
// ------------>Primitives in pad: canvy_2
   ...
   p_muonElectron2_eta_SF__6->SetMinimum(0.8);
   p_muonElectron2_eta_SF__6->SetMaximum(1.2);
   p_muonElectron2_eta_SF__6->SetLineColor(4);
   p_muonElectron2_eta_SF__6->SetLineWidth(2);
   p_muonElectron2_eta_SF__6->SetMarkerColor(4);
   ...
   p_muonElectron2_eta_SF__6->GetXaxis()->SetLabelSize(0.12);
   p_muonElectron2_eta_SF__6->GetXaxis()->SetTitleSize(0.135);
   ...
   p_muonElectron2_eta_SF__6->GetYaxis()->SetNdivisions(506);
   ...
   p_muonElectron2_eta_SF__6->GetYaxis()->SetTitleSize(0.135);
   p_muonElectron2_eta_SF__6->GetYaxis()->SetTitleOffset(0.39);
