...
// ------------>Primitives in pad: canvy_1
   ...
   TProfile *muonElectron1_eta_MC = new TProfile("muonElectron1_eta_MC","",5, xAxis);
   ...
   muonElectron1_eta_MC->GetXaxis()->SetTitle(" Electron #eta");
   ...
   muonElectron1_eta_MC->GetYaxis()->SetTitle(" Trigger Efficiency");
   muonElectron1_eta_MC->GetYaxis()->SetLabelFont(42);
   muonElectron1_eta_MC->GetYaxis()->SetLabelFont(42);
   muonElectron1_eta_MC->GetYaxis()->SetLabelOffset(0.01);
   muonElectron1_eta_MC->GetYaxis()->SetLabelSize(0.056);
   muonElectron1_eta_MC->GetYaxis()->SetTitleSize(0.0645);
   muonElectron1_eta_MC->GetYaxis()->SetTitleOffset(0.785);
...
// ------------>Primitives in pad: canvy_2
   ...
   p_muonElectron1_eta_SF__5->GetXaxis()->SetLabelSize(0.12);
   p_muonElectron1_eta_SF__5->GetXaxis()->SetTitleSize(0.135);
   ...
   p_muonElectron1_eta_SF__5->GetYaxis()->SetTitleSize(0.135);
   p_muonElectron1_eta_SF__5->GetYaxis()->SetTitleOffset(0.39);
