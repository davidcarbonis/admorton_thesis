...
// ------------>Primitives in pad: canvy_2
   ...
   p_muonElectron1_eta_SF__5->GetXaxis()->SetLabelSize(0.10);
   ...
   p_muonElectron1_eta_SF__5->GetYaxis()->SetLabelSize(0.10);
   p_muonElectron1_eta_SF__5->GetYaxis()->SetTitleSize(0.12);
   p_muonElectron1_eta_SF__5->GetYaxis()->SetTitleOffset(0.4);
