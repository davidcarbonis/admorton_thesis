...
// ------------>Primitives in pad: canvy_2
   ...
   p_muonElectron1_pT_SF__10->GetXaxis()->SetLabelSize(0.10);
   ...
   p_muonElectron1_pT_SF__10->GetYaxis()->SetLabelSize(0.10);
   p_muonElectron1_pT_SF__10->GetYaxis()->SetTitleSize(0.12);
   p_muonElectron1_pT_SF__10->GetYaxis()->SetTitleOffset(0.4);
