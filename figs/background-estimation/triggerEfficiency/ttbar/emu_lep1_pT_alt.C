...
// ------------>Primitives in pad: canvy_1
   ...
   muonElectron1_pT_MC->GetYaxis()->SetLabelSize(0.062);
   muonElectron1_pT_MC->GetYaxis()->SetTitleSize(0.08);
   muonElectron1_pT_MC->GetYaxis()->SetTitleOffset(0.58);
...
// ------------>Primitives in pad: canvy_2
   ...
   p_muonElectron1_pT_SF__10->SetMinimum(0.9);
   p_muonElectron1_pT_SF__10->SetMaximum(1.1);
   ...
   p_muonElectron1_pT_SF__10->GetXaxis()->SetLabelSize(0.13);
   p_muonElectron1_pT_SF__10->GetXaxis()->SetTitleSize(0.13);
   ...
   p_muonElectron1_pT_SF__10->GetYaxis()->SetTitleSize(0.16);
   p_muonElectron1_pT_SF__10->GetYaxis()->SetTitleOffset(0.3);
