...
// ------------>Primitives in pad: canvy_2
   ...
   p_muonElectron2_pT_SF__12->GetXaxis()->SetLabelSize(0.10);
   ...
   p_muonElectron2_pT_SF__12->GetYaxis()->SetLabelSize(0.10);
   p_muonElectron2_pT_SF__12->GetYaxis()->SetTitleSize(0.12);
   p_muonElectron2_pT_SF__12->GetYaxis()->SetTitleOffset(0.4);
