...
// ------------>Primitives in pad: canvy_2
   ...
   p_muonElectron2_pT_SF__12->SetLineColor(4);
   p_muonElectron2_pT_SF__12->SetLineWidth(2);
   p_muonElectron2_pT_SF__12->SetMarkerColor(4);
   ...
   p_muonElectron2_pT_SF__12->GetXaxis()->SetLabelSize(0.12);
   p_muonElectron2_pT_SF__12->GetXaxis()->SetTitleSize(0.135);
   ...
   p_muonElectron2_pT_SF__12->GetYaxis()->SetTitleSize(0.135);
   p_muonElectron2_pT_SF__12->GetYaxis()->SetTitleOffset(0.39);
