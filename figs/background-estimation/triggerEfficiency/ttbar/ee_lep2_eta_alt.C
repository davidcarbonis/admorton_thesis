...
// ------------>Primitives in pad: canvy_2
   ...
   p_electron2_eta_SF__2->GetXaxis()->SetLabelSize(0.10);
   ...
   p_electron2_eta_SF__2->GetYaxis()->SetLabelSize(0.10);
   p_electron2_eta_SF__2->GetYaxis()->SetTitleSize(0.12);
   p_electron2_eta_SF__2->GetYaxis()->SetTitleOffset(0.4);
