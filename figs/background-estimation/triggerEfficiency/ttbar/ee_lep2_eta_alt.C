...
// ------------>Primitives in pad: canvy_2
   ...
   p_electron2_eta_SF__2->SetLineColor(4);
   p_electron2_eta_SF__2->SetLineWidth(2);
   p_electron2_eta_SF__2->SetMarkerColor(4);
   ...
   p_electron2_eta_SF__2->GetXaxis()->SetLabelSize(0.12);
   p_electron2_eta_SF__2->GetXaxis()->SetTitleSize(0.135);
   ...
   p_electron2_eta_SF__2->GetYaxis()->SetTitleSize(0.135);
   p_electron2_eta_SF__2->GetYaxis()->SetTitleOffset(0.39);
