...
// ------------>Primitives in pad: canvy_2
   ...
   p_electron1_pT_SF__1->GetXaxis()->SetLabelSize(0.10);
   ...
   p_electron1_pT_SF__1->GetYaxis()->SetLabelSize(0.10);
   p_electron1_pT_SF__1->GetYaxis()->SetTitleSize(0.12);
   p_electron1_pT_SF__1->GetYaxis()->SetTitleOffset(0.4);
