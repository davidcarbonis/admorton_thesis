...
// ------------>Primitives in pad: canvy_2
   ...
   p_electron1_pT_SF__1->SetLineColor(4);
   p_electron1_pT_SF__1->SetLineWidth(2);
   p_electron1_pT_SF__1->SetMarkerColor(4);
   ...
   p_electron1_pT_SF__1->GetXaxis()->SetLabelSize(0.12);
   p_electron1_pT_SF__1->GetXaxis()->SetTitleSize(0.135);
   ...
   p_electron1_pT_SF__1->GetYaxis()->SetTitleSize(0.135);
   p_electron1_pT_SF__1->GetYaxis()->SetTitleOffset(0.39);
