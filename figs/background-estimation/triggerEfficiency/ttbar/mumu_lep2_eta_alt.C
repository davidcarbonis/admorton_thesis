...
// ------------>Primitives in pad: canvy_2
   ...
   p_muon2_eta_SF__4->GetXaxis()->SetLabelSize(0.10);
   ...
   p_muon2_eta_SF__4->GetYaxis()->SetLabelSize(0.10);
   p_muon2_eta_SF__4->GetYaxis()->SetTitleSize(0.12);
   p_muon2_eta_SF__4->GetYaxis()->SetTitleOffset(0.4);
