...
// ------------>Primitives in pad: canvy_1
   ...
   electron2_pT_MC->GetYaxis()->SetLabelSize(0.05);
   electron2_pT_MC->GetYaxis()->SetTitleSize(0.06);
   electron2_pT_MC->GetYaxis()->SetTitleOffset(0.8);
...
// ------------>Primitives in pad: canvy_2
   ...
   p_electron2_pT_SF__3->GetXaxis()->SetLabelSize(0.10);
   p_electron2_pT_SF__3->GetXaxis()->SetTitleSize(0.13);
   ...
   p_electron2_pT_SF__3->GetYaxis()->SetLabelSize(0.10);
   p_electron2_pT_SF__3->GetYaxis()->SetTitleSize(0.12);
   p_electron2_pT_SF__3->GetYaxis()->SetTitleOffset(0.4);
