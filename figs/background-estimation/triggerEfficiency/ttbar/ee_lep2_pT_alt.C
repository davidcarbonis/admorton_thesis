...
// ------------>Primitives in pad: canvy_1
   ...
   electron2_pT_MC->GetYaxis()->SetLabelSize(0.062);
   electron2_pT_MC->GetYaxis()->SetTitleSize(0.08);
   electron2_pT_MC->GetYaxis()->SetTitleOffset(0.58);
...
// ------------>Primitives in pad: canvy_2
   ...
   p_electron2_pT_SF__3->GetXaxis()->SetLabelSize(0.13);
   ...
   p_electron2_pT_SF__3->GetYaxis()->SetTitleSize(0.16);
   p_electron2_pT_SF__3->GetYaxis()->SetTitleOffset(0.3);
