...
// ------------>Primitives in pad: canvy_1
   ...
   muon1_eta_MC->GetYaxis()->SetLabelSize(0.062);
   muon1_eta_MC->GetYaxis()->SetTitleSize(0.08);
   muon1_eta_MC->GetYaxis()->SetTitleOffset(0.58);
...
// ------------>Primitives in pad: canvy_2
   ...
   p_muon1_eta_SF__3->GetXaxis()->SetLabelSize(0.13);
   ...
   p_muon1_eta_SF__3->GetYaxis()->SetTitleSize(0.16);
   p_muon1_eta_SF__3->GetYaxis()->SetTitleOffset(0.3);
