...
// ------------>Primitives in pad: canvy_1
   ...
   TProfile *muon1_eta_MC = new TProfile("muon1_eta_MC","",5, xAxis);
   ...
   muon1_eta_MC->GetXaxis()->SetTitle(" Leading muon #eta");
   ...
   muon1_eta_MC->GetYaxis()->SetTitle(" Trigger Efficiency");
   muon1_eta_MC->GetYaxis()->SetLabelFont(42);
   muon1_eta_MC->GetYaxis()->SetLabelFont(42);
   muon1_eta_MC->GetYaxis()->SetLabelOffset(0.01);
   muon1_eta_MC->GetYaxis()->SetLabelSize(0.056);
   muon1_eta_MC->GetYaxis()->SetTitleSize(0.0645);
   muon1_eta_MC->GetYaxis()->SetTitleOffset(0.785);
...
// ------------>Primitives in pad: canvy_2
   ...
   p_muon1_eta_SF__3->SetLineColor(4);
   p_muon1_eta_SF__3->SetLineWidth(2);
   p_muon1_eta_SF__3->SetMarkerColor(4);
   ...
   p_muon1_eta_SF__3->GetXaxis()->SetLabelSize(0.12);
   p_muon1_eta_SF__3->GetXaxis()->SetTitleSize(0.135);
   ...
   p_muon1_eta_SF__3->GetYaxis()->SetLabelSize(0.12);
   p_muon1_eta_SF__3->GetYaxis()->SetTitleSize(0.135);
   p_muon1_eta_SF__3->GetYaxis()->SetTitleOffset(0.39);
