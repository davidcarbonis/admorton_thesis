...
//   Canvas_1_n2->Range(-0.4860759,-0.2025316,2.551899,1.063291); // tmtt plot range
   ...
   TProfile *electron1_eta_MC = new TProfile("electron1_eta_MC_ttbar","ee final state - leading electron",5, xAxis);
   ...
   electron1_eta_MC_ttbar->SetMinimum(0.8);
   electron1_eta_MC_ttbar->SetMaximum(1.1);
   ...
   electron1_eta_MC_ttbar->Draw("E1");
   ...
   electron1_eta_MC_DY->GetXaxis()->SetTitle(" #eta");
   ...
   electron1_eta_MC_DY->GetYaxis()->SetTitle(" Efficiency");
   ...
   electron1_eta_MC_DY->Draw("same E1");
