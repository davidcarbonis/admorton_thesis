...
//=========  (Sun Aug 25 20:59:23 2019) by ROOT version 6.18/00
   ...
   muon2_pT_MC_DY->GetXaxis()->SetLabelSize(0.045);
   muon2_pT_MC_DY->GetXaxis()->SetLabelOffset(0.01);
   muon2_pT_MC_DY->GetXaxis()->SetTitleSize(0.045);
   muon2_pT_MC_DY->GetXaxis()->SetTitleOffset(1.2);
   ...
   muon2_pT_MC_DY->GetYaxis()->SetLabelSize(0.045);
   muon2_pT_MC_DY->GetYaxis()->SetLabelOffset(0.01);
   muon2_pT_MC_DY->GetYaxis()->SetTitleSize(0.045);
   muon2_pT_MC_DY->GetYaxis()->SetTitleOffset(1.2);
